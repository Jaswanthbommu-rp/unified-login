...
{
	public class GetUserByEnterpriseUserName : TestController
	{
		...
		public GetUserByEnterpriseUserName(ITestOutputHelper _xUnitTestOutput)
		{
		...
		public void GetGetUserByEnterpriseUserName()
		{
			// Set up the API URL
			userDetails = reusable.DoSelectUser();
			EndPointUrl = HostIdentityUrl + Properties["GetUserByEnterpriseUserName"]
