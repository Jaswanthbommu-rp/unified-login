...
{
	public class UpdateConsent : TestController
	{
		...
		public UpdateConsent(ITestOutputHelper _xUnitTestOutput)
		{
			reusable = new TestUtilities(this);
			this.XunitTestOutPut = _xUnitTestOutput;
		}

		// UpdateConsent=/api/IdentityConfig/UpdateConsent  

		//[Fact, Trait("", "Happy Path")]
		public void PostUpdateConsent()
		{
			// Set up Payload
			...
			EndPointUrl = HostIdentityUrl + Properties["UpdateConsent"];
