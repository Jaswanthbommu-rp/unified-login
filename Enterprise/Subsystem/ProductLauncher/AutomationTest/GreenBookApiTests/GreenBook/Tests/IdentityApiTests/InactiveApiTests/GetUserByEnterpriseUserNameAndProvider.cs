...
{
	public class GetUserByEnterpriseUserNameAndProvider : TestController
	{
		...
		public GetUserByEnterpriseUserNameAndProvider(ITestOutputHelper _xUnitTestOutput)
		{
			this.XunitTestOutPut = _xUnitTestOutput;
		}

		// GetUserByEnterpriseUserNameAndProvider=/api/IdentityConfig/GetUserByEnterpriseUserNameAndProvider 

		/*Disabling this test since GET GetUserByEnterpriseUserNameAndProvider has already been deprecated */
		//[Fact, Trait("", "Happy Path")]
		public void GetGetUserByEnterpriseUserNameAndProvider()
		{
			// Set up the API URL
			userDetails = reusable.DoSelectUser();
			EndPointUrl = HostIdentityUrl + Properties["GetUserByEnterpriseUserNameAndProvider"]
				+ "?enterpriseUserName=" + WebUtility.UrlEncode(userDetails.Rows[0]["LoginId"].ToString()) 
				+ "&externalIdentity=" + userDetails.Rows[0]["IdentityProvider"];
