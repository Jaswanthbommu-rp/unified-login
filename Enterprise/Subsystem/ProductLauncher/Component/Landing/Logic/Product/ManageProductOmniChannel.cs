...
using Property = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.OmniChannel.Property;
using PropertyRole = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.OmniChannel.PropertyRole;
using UL = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.UserManagement;
using UserAccessGroup = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.OmniChannel.UserAccessGroup;
using UserAssignProductPropertyRole = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.OmniChannel.UserAssignProductPropertyRole;
using UserLocation = RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Product.OmniChannel.UserLocation;
...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
    ...
    public class ManageProductOmniChannel : ManageProductBase, IManageProductOmniChannel
    {
        ...
        public ManageProductOmniChannel(DefaultUserClaim userClaims) : base((int)ProductEnum.OmniChannel, userClaims, null, null)
        {
