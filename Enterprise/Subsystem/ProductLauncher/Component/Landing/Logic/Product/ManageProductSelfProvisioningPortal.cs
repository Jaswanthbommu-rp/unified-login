...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
    ...
    public class ManageProductSelfProvisioningPortal : ManageProductBase, IManageProductSelfProvisioningPortal
    {
        ...
        public ManageProductSelfProvisioningPortal(DefaultUserClaim userClaims) : base((int)ProductEnum.SelfProvisioningPortal, userClaims, productInternalSettingRepository: null, productRepository: null, cache: null)
        {
