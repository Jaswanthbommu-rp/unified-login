        ...
        private string GetOneSitePMCIDFromPersona(Persona persona)
        {
            ...
            if (uniqueIdentifier == null)
            {
                ...
                else
                {
                    ...
                    IList<CustomerCompanyMap> companyMapResource = _blueBook.GetCompanyMap(persona.Organization.BooksCustomerMasterId, source: BlueBookProductConstants.OneSite, domain: persona.Organization.OrganizationDomain.Name);
