...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
    public class ManageProductClientPortal : ManageProductBase, IManageProductClientPortal
    {
        ...
        public ManageProductClientPortal(DefaultUserClaim userClaims) : base((int)ProductEnum.ClientPortal, userClaims, productInternalSettingRepository: null, productRepository: null, cache: null)
        {
#if DEBUG
