	...
	public class ManageProductOneSiteAccounting : ManageProductBase, IManageProductOneSiteAccounting
	{
		...
		private string GetAccountingCompanyFromPersona(Persona persona)
		{
			...
			if (uniqueIdentifier == null)
			{
                ...
                IList<blueBook.CustomerCompanyMap> companyMap = _blueBook.GetCompanyMap(persona.Organization.RealPageId, persona.Organization.BooksCustomerMasterId, source: BlueBookProductConstants.FinancialSuite, domain: persona.OrganizationDomain);
