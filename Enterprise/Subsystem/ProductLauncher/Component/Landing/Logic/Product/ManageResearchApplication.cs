...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
	...
	public class ManageResearchApplication : ManageProductBase, IManageResearchApplication
    {
		...
		public ManageResearchApplication(DefaultUserClaim userClaims) : base((int)ProductEnum.ResearchApplication, userClaims, null)
        {
		...
		public ListResponse GetRoles(long editorPersonaId, long userPersonaId, long partyId)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.ErrorReason = $"ResearchApplication - ManageResearchApplication.GetRoles  There was a problem getting the roles.";
