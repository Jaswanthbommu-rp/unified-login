...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
	...
	public class ManageProductBase : IDisposable
    {
        ...
        protected CustomerCompanyMap GetProductCompanyInstanceId(string blueBookProductName, string includeExtra = "")
        {
            ...
            IList<CustomerCompanyMap> companyProductList = _blueBook.GetCompanyMap(_editorPersona.Organization.BooksCustomerMasterId, source: blueBookProductName.ToUpper(), IncludeExtra: includeExtra, domain: _editorPersona.Organization.OrganizationDomain.Name);
