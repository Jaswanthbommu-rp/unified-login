...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Product
{
    ...
    public class ManageProductOps : ManageProductBase, IManageProductOps
    {
        ...
        /// Default constructor
        /// </summary>
        public ManageProductOps(DefaultUserClaim userClaims) : base((int)ProductEnum.OpsBuyer, userClaims, productInternalSettingRepository: null, productRepository: null, cache: null)
        {
