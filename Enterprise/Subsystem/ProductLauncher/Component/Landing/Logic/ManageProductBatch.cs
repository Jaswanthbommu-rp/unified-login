    ...
    public class ManageProductBatch
    {
        ...
        public  ManageProductBatch (DefaultUserClaim userClaims)
        {
			...
			_integrationTypeFactory = new IntegrationTypeFactory(manageProduct, manageUnifiedLogin,
				manageProductOneSite, _productRepository, productInternalSettingRepository, _userClaims);
		}

		public ManageProductBatch(IProductRepository productRepository, IPropertyRepository propertyRepository)
		{
