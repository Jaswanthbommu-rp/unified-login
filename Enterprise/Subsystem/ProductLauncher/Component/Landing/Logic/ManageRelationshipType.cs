...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic
{
    ...
    public class ManageRelationshipType : IManageRelationshipType
    {
        ...
        public IList<UserRelationShipType> GetUserRelationShipTypes()
        {
            ...
            if (DefaultUserClaim.EmployeeCompanyRealPageId == _userClaims.OrganizationRealPageGuid && (persona.UserTypeId == (int)UserRoleType.SuperUser || persona.UserTypeId == (int)UserRoleType.User))
            {
