...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Repository
{
	...
	public class PropertyRepository : BaseRepository, IPropertyRepository
	{
        ...
        public List<PropertySetup> GetPropertiesForCompany(List<Guid> propertyInstanceIds, string propertyName = null, int? blueId = null, RequestParameter dataFilterSort = null)
        {
            string sortBy = "Name";
