...
namespace RP.Enterprise.Subsystem.ProductLauncher.Service.LandingAPI.Controllers
{
    ...
    public class OrganizationController : BaseApiController
    {
        ...
        public HttpResponseMessage InsertOrganization([FromBody] OrganizationCreate organization, bool processBlueBookMessage = false)
        {
            ...
            IList<CustomerCompanyMap> companyMapResource = _manageBlueBook.GetCompanyMap(booksCompanyMasterId: organization.BooksCustomerMasterId, source: ProductEnumHelper.StringValueOf(ProductEnum.UnifiedPlatform), includeGreenBookCares: false, domain: result.obj.Org.OrganizationDomain.Name);
        ...
        public HttpResponseMessage UpdateOrganization([FromBody] OrganizationUpdate organization)
        {
            ...
            if (orgNameChanged)
            {
                ...
                IList<CustomerCompanyMap> companyMapResource = _manageBlueBook.GetCompanyMap(booksCompanyMasterId: org.BooksCustomerMasterId, source: ProductEnumHelper.StringValueOf(ProductEnum.UnifiedPlatform), includeGreenBookCares: false, domain: organization.OrganizationDomainName);
        ...
        public HttpResponseMessage SyncBooksOrganizations(bool commit = false)
        {
            ...
            foreach (var organization in orgList)
            {
                ...
                IList<CustomerCompanyMap> companyMapResource = _manageBlueBook.GetCompanyMap(booksCompanyMasterId: organization.BooksCustomerMasterId, source: ProductEnumHelper.StringValueOf(ProductEnum.UnifiedPlatform), includeGreenBookCares: false, domain: organization.OrganizationDomain.Name);
