...
namespace RP.Enterprise.Subsystem.ProductLauncher.Service.LandingAPI.Controllers
{
	...
	/// 
	/// </summary>
	public class ProductClientPortalController :   BaseApiController
    {
        ...
        /// Default constructor
        /// </summary>
        public ProductClientPortalController() : base() { }

        /// <summary>
        /// Used for unit testing
        /// </summary> 
        public ProductClientPortalController(IManageProductClientPortal manageProductClientPortal)
        {
            _manageProductClientPortal = manageProductClientPortal;
        ...
        public HttpResponseMessage GetRoles(long editorPersonaId, long userPersonaId, [FromUri]RequestParameter datafilter)
        {
            ...
            var result = _manageProductClientPortal.GetRoles(editorPersonaId, userPersonaId, datafilter);
        ...
        public HttpResponseMessage GetProperties(long editorPersonaId, long userPersonaId, [FromUri]RequestParameter datafilter)
        {
            ...
            var result = _manageProductClientPortal.GetProperties(editorPersonaId, userPersonaId, datafilter);
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Description = "Bad request(when data filter have invalid entries / when information is out of sync with the server)")]
        [Route("products/clientportal/migration-users")]
        ...
        public HttpResponseMessage ListClientPortalMigrationUsers(long editorPersonaId, [FromUri]RequestParameter datafilter)
        {
            ...
            var _manageProductClientPortal = new ManageProductClientPortal(base._userClaims);
            return Request.CreateResponse(HttpStatusCode.OK, _manageProductClientPortal.GetMigrationUsers(editorPersonaId, datafilter));
        }
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Description = "Bad request(when data filter have invalid entries / when information is out of sync with the server)")]
        [Route("products/clientportal/migrate-users")]
        [Authorize]
        [HttpPut]
        public HttpResponseMessage UpdateUsersMigrationStatus(IList<MigrateUser> migrateUsers)
        {            
            return Request.CreateResponse(HttpStatusCode.OK, _manageProductClientPortal.UpdateUsersMigrationStatus(_personaId, migrateUsers));
        }
        ...
        [Route("products/clientportal/user/MT/status")]
        [Authorize]
        [HttpPut]
        public HttpResponseMessage UpdateClientPortalUserStatus(ProductUser productUser)
        {
            var _manageProductClientPortal = new ManageProductClientPortal(base._userClaims);
            if (!_manageProductClientPortal.ChangeUserStatus(_personaId, productUser.UserLogin))
            {
