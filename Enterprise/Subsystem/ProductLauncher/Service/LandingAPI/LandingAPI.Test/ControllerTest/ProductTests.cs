    ...
    public class ProductTests
    {
        ...
        internal void FillInstanceData(int ProductId, long PersonaId, long UserId, string TestCaseName)
        {
            ...
            personaList = new List<Persona>()
            {
              new Persona()
              {
                    FromDate = Convert.ToDateTime("27/10/2023 3:47:13 PM"),
                    IsDefault = false,
                    Name = "Primary",
                    Organization = null,
            ...
            {
              new AdGroup() { ADGroupId = 1, ADGroupName = null, ActiveDirectoryId = new Guid("00000000-0000-0000-0000-000000000000"), CreatedDate = Convert.ToDateTime("23/11/2023 10:00:20 AM") }
            };
