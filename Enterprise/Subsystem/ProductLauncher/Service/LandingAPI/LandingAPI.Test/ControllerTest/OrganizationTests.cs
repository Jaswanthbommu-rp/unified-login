...
namespace RP.Enterprise.Subsystem.ProductLauncher.LandingAPI.Test.ControllerTest
{
    ...
    public class OrganizationTests : TestBase
    {
        ...
        public void OrganizationProductTest()
        {
            ...
            {
                (int)ProductEnum.UnifiedUI, (int)ProductEnum.SelfProvisioningPortal, (int)ProductEnum.SalesForce, (int)ProductEnum.SettingsManagement, (int)ProductEnum.Facilities,(int)ProductEnum.LRConversionPortal,(int)ProductEnum.AdminSupportPortal,(int)ProductEnum.KnockCRM,(int)ProductEnum.G5LLMarketing,(int)ProductEnum.DataHub,(int)ProductEnum.SustainabilityServices , (int)ProductEnum.Web2PrintSocial,(int)ProductEnum.ManagedServices
            };
