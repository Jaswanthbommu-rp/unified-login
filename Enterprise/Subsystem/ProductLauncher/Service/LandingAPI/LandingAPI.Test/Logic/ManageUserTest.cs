...
namespace RP.Enterprise.Subsystem.ProductLauncher.LandingAPI.Test.Logic
{
	...
	public class ManageUserTest
    {
        ...
        public void CreateNewUser_MockInputData_ReturnValidRepositoryResponseObject()
        {
            ...
            IManageUserRegistrationEmail userRegistrationEmail = new ManageUserRegistrationEmail(userClaims, _mockEmailLogic.Object, _mockContactMechanismRepository.Object, _mockCommunicationEventsLogic.Object, _mockUserTokenRepository.Object, _mockManagePerson.Object, _mockUserLoginRepository.Object);
        ...
        public void UpdateNewUser_MockInputData_ReturnValidRepositoryResponseObject()
        {
            ...
            IManageUserRegistrationEmail userRegistrationEmail = new ManageUserRegistrationEmail(userClaims, _mockEmailLogic.Object, _mockContactMechanismRepository.Object, null, null, _mockManagePerson.Object, _mockUserLoginRepository.Object);
            ManageUser manageUser = new ManageUser(_mockUserRepository.Object, _mockCredentialRepository.Object, _mockUserLoginRepository.Object, userRegistrationEmail, userClaims);
		...
		[Fact]
		public void GetUser_InvalidNullInputObject_ExceptionThrown()
		{
            //Arrange
            ManageUser manageUser = new ManageUser(_mockUserRepository.Object, _mockCredentialRepository.Object, _mockUserLoginRepository.Object, null, userClaims);
            ...
            //Assert
            Assert.Throws<ArgumentNullException>(() => manageUser.GetUser(null));
		}

		[Fact]
		public void GetUser_InvalidInputObject_ExceptionThrown()
		{
            //Arrange
            IManageUserRegistrationEmail userRegistrationEmail = new ManageUserRegistrationEmail(userClaims, _mockEmailLogic.Object, _mockContactMechanismRepository.Object, _mockCommunicationEventsLogic.Object, _mockUserTokenRepository.Object, _mockManagePerson.Object, _mockUserLoginRepository.Object);
            ManageUser manageUser = new ManageUser(_mockUserRepository.Object, _mockCredentialRepository.Object, _mockUserLoginRepository.Object, null, userClaims);
            ...
            //Assert
            Assert.Throws<Exception>(() => manageUser.GetUser(0));
		}

		[Fact]
		public void GetUser_NotFound_ReturnUserDetailsResponse()
		{
			//Arrange
			int enterpriseUserdId = -100;
			var mockObject = new Mock<IUserRepository>();
			mockObject.Setup(m => m.GetEnterpriseUser(enterpriseUserdId)).Returns(() => null);

            //Act
            IManageUserRegistrationEmail userRegistrationEmail = new ManageUserRegistrationEmail(userClaims, _mockEmailLogic.Object, _mockContactMechanismRepository.Object, _mockCommunicationEventsLogic.Object, _mockUserTokenRepository.Object, _mockManagePerson.Object, _mockUserLoginRepository.Object);
            ManageUser manageUser = new ManageUser(_mockUserRepository.Object, _mockCredentialRepository.Object, _mockUserLoginRepository.Object, null, userClaims);

            UserDetailsResponse response = manageUser.GetUser(enterpriseUserdId);
		...
		[Fact]
		public void GetUser_Found_ReturnValidUserDetailsResponse()
		{
			//Arrange
			int enterpriseUserdId = 100;
			User user = new User()
			{
				...
				UserId = enterpriseUserdId,
				Firstname = "test",
				Lastname = "test"
			};

			var _mockUserRepository = new Mock<IUserRepository>();
			_mockUserRepository.Setup(m => m.GetEnterpriseUser(enterpriseUserdId)).Returns(user);
			...
			//Assert
			Assert.True(
				response.UserDetails.UserId == enterpriseUserdId
				&& response.UserDetails.LoginId == "test@test.com"
			);
		}

		[Fact]
		public void GetAccountExpiration_InvalidNullInputObject_ExceptionThrown()
		{
            //Arrange
            IManageUserRegistrationEmail userRegistrationEmail = new ManageUserRegistrationEmail(userClaims, _mockEmailLogic.Object, _mockContactMechanismRepository.Object, _mockCommunicationEventsLogic.Object, _mockUserTokenRepository.Object, _mockManagePerson.Object, _mockUserLoginRepository.Object);
            ManageUser manageUser = new ManageUser(_mockUserRepository.Object, _mockCredentialRepository.Object, _mockUserLoginRepository.Object, null, userClaims);
		...
		public void ValidateUser_Error_UnableToGetToken()
		{
            ...
            Assert.True(response.ErrorReason.Equals("Account is inactive.", StringComparison.OrdinalIgnoreCase));
            ...
            Assert.True(response.ErrorReason.Equals("Profile already completed.", StringComparison.OrdinalIgnoreCase));
            ...
            //Assert
            response = manageUser.ValidateUser(enterpriseUserdName, "t");
            Assert.True(response.ErrorReason.Equals("This link has expired. Please contact your System Administrator.", StringComparison.OrdinalIgnoreCase));
