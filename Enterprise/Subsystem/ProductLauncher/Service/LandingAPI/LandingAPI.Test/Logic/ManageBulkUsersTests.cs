...
namespace RP.Enterprise.Subsystem.ProductLauncher.Component.Landing.Logic.Tests
{
    ...
    public class ManageBulkUsersTests
    {
        ...
        public void ProcessProductUnAssignBatchData_ReturnsEmptyString_WhenNoProductsToUnassign()
        {
         ...
         .Returns(new List<RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Organization> { new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Organization { PartyId = 10, RelationshipType = "User Type", RoleNameFrom = "External User" } });
        ...
        public void ProcessProductUnAssignBatchData_ReturnsError_WhenSaveProductBatchFails()
        {
            ...
            _userLoginRepositoryMock.Setup(x => x.ListOrganizationByEnterpriseUserId(It.IsAny<Guid>(), null))
                .Returns(new List<RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Organization>
                {
                    new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Organization
                    {
                        PartyId = 10,
            ...
            var bulkUserBatch = new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserBatch
            {
                BulkUserBatchProcessId = 1,
                EditorUserPersonaId = 1,
                SubjectUserPersonaId = 2,
                BatchProcessTypeId = 1,
                BulkUserProducts = new List<RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserProduct>
                {
                    new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserProduct
                    {
                        ProductId = 1,
                        BulkUserBatchProcessId = 1
                    }
            ...
            var bulkUserBatch2 = new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserBatch
            {
                BulkUserBatchProcessId = 1,
                EditorUserPersonaId = 1,
                SubjectUserPersonaId = 2,
        ...
        public void ProcessProductUnAssignBatchData_ReturnsEmptyString_WhenBatchIsCompleted()
        {
            ...
            var bulkUserBatch = new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserBatch
            {
                ...
                BulkUserProducts = new List<RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserProduct>
                {
                    new RP.Enterprise.Subsystem.ProductLauncher.Component.SharedObjects.Batch.BulkUserProduct { ProductId = 1, BulkUserBatchProcessId = 1 }
                }
            };
            var getUserBatchRecordMethod = typeof(ManageBulkUsers).GetMethod("GetUserBatchRecord", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            getUserBatchRecordMethod.Invoke(_manageBulkUsers, new object[] { 1 });
