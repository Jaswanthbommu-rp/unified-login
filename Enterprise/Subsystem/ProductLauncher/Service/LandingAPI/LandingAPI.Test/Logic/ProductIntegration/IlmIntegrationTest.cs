...
namespace RP.Enterprise.Subsystem.ProductLauncher.LandingAPI.Test.Logic.ProductIntegration
{
	...
	public class IlmIntegrationTest
	{
		ProductEnum productType = ProductEnum.LeadManagement;
		GbProductMap gbProductMap = new GbProductMap { Name = "ILM", BooksProductCode = "ILM", ProductId = 40 };
		...
		static readonly string CompanyInstanceSourceId = IlmTestData.CompanyInstanceSourceId;
		static readonly string SubjectUserLoginName = IlmTestData.SubjectUserLoginName;
		static readonly string UpdateInputJson = IlmTestData.UpdateInputJson;
		...
		public IlmIntegrationTest()
		{
			productInternalSettingList = IlmTestData.Get_DEV_ILM_ProductSettings();
