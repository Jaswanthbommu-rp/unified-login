...
namespace RP.Enterprise.Subsystem.ProductLauncher.LandingAPI.Test.Logic.ProductIntegration
{
	...
	public class IlaIntegrationTest
	{
		ProductEnum productType = ProductEnum.LeadAnalytics;
		GbProductMap gbProductMap = new GbProductMap { Name = "ILA", BooksProductCode = "ILA", ProductId = 41 };
		...
		static readonly string CompanyInstanceSourceId = IlaTestData.CompanyInstanceSourceId;
		static readonly string SubjectUserLoginName = IlaTestData.SubjectUserLoginName;
		static readonly string UpdateInputJson = IlaTestData.UpdateInputJson;
		...
		public IlaIntegrationTest()
		{
			productInternalSettingList = IlaTestData.Get_DEV_ILA_ProductSettings();
