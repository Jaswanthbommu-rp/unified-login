...
namespace RP.Enterprise.Subsystem.ProductLauncher.LandingAPI.Test.Logic.ProductIntegration
{
	...
	public class DiqIntegrationTest
	{
		ProductEnum productType = ProductEnum.DepositAlternative;
		GbProductMap gbProductMap = new GbProductMap { Name = "DIQ", BooksProductCode = "DIQ", ProductId = 47 };

		static readonly string CompanyInstanceSourceId = DiqTestData.CompanyInstanceSourceId;
		static readonly string SubjectUserLoginName = DiqTestData.SubjectUserLoginName;
		static readonly string UpdateInputJson = DiqTestData.UpdateInputJson;
		...
		public DiqIntegrationTest()
		{
			productInternalSettingList = DiqTestData.Get_DEV_DIQ_ProductSettings();
		...
		[Fact(Skip = "Integration test")]
		public void GetPropertyGroups_Test()
		{
			var productLogic =
				ManageProductFactory.GetProductLogic(productType, editorPersonaId, subjectPersonaId, userClaims,
					dataCollector.Object, managePersona.Object, productInternalSettingRepository.Object);
			var result = productLogic.GetProductPropertyGroups(null);
		...
		public void UpdateUser_Test()
		{
            ...
            subjectPersonaId = 34;
			dataCollector.Setup(m => m.GetUserDetailsByPersona(subjectPersonaId, (int)productType)).Returns(subjectUserDetails);
			//UpdateProductSettingProductStatus(SubjectUserDetails.PersonaId, PRODUCT_SETTINGTYPE_STATUS, ProductId, (int)ProductBatchStatusType.Success);
