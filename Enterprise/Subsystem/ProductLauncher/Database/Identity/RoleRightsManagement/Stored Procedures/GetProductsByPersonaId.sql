...
BEGIN      
 ...
 [Name] [nvarchar](50) NOT NULL  
    ...
    SELECT ps.[ProductSettingId],ps.[ProductId],ps.[ProductSettingTypeId],ps.[Value],ps.[ThruDate]   from Enterprise.ProductSetting  ps
	inner join #TEMPProductSettingType temppst on temppst.ProductSettingTypeId = ps.ProductSettingTypeId
 ...
 IF EXISTS(SELECT TOP 1 1 FROM [Security].[ADGroupUser] WHERE PersonaId = @PersonaId)
 BEGIN
