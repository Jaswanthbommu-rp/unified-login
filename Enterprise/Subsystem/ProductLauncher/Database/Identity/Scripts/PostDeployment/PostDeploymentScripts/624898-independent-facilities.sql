...
BEGIN
	INSERT INTO Security.[Right](RightName, Description, Value, StatusTypeId, VisibilityStatusId, ProductId, TargetProductId, CreatedBy, CreatedDate)
	VALUES('81addeditpmtemplate', 'Ability to create and edit an Inspection template', 'Ability to create and edit an Inspection template', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('81assignschedpm', 'Ability to create Inspection events', 'Ability to create Inspection events', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('81compchecklist', 'Ability to complete Inspection checklists', 'Ability to complete Inspection checklists', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('83editadvancetimesheet', 'Ability to edit technicians timesheet entries created by the mobile app', 'Ability to edit technicians timesheet entries created by the mobile app', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('83viewalltechs', 'Ability to view historical geo-location for all maintenance techs', 'Ability to view historical geo-location for all maintenance techs', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('86ManageMCAmenityContent', 'Permission to modify Marketing Amenity Content', 'Permission to modify Marketing Amenity Content', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('87bulkupdateturnboard', 'Ability to manage move out inspection and turn task in bulk', 'Ability to manage move out inspection and turn task in bulk', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('87editturnboard', 'Edit turn board', 'Edit turn board', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('87editturnboardchecklist', 'Ability to edit turn board checklist', 'Ability to edit turn board checklist', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('87gensemturn', 'Add a semester turn and view turn board', 'Add a semester turn and view turn board', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('87viewturnboard', 'View turn board', 'View turn board', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('89assignwarrantytoasset', 'Ability to assign a warranty to an asset', 'Ability to assign a warranty to an asset', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8abtrlebal', 'Ability to clear residents ledger balances', 'Ability to clear residents ledger balances', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8addasset', 'Add and view asset records', 'Add and view asset records', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8addmr', 'Add and view make ready requests', 'Add and view make ready requests', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8addmrrenov', 'Ability to create make ready items for renovations', 'Edit closed work order to create make ready items for renovations', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8addsr', 'Add and view service requests', 'Add and view service requests', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8approveresidentcharge', 'Can approve resident charges', 'Can approve resident charges', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8assignsr', 'Assign or reassign SR to a maintenance tech', 'Assign or reassign SR to a maintenance tech', 13, 9, 82, 82, @UserId, GETDATE())
     	 ,('8bdonholdsr', 'Ability to set on hold SR dates to a previous date', 'Ability to set on hold SR dates to a previous date', 13, 9, 82, 82, @UserId, GETDATE())	
		 ,('8bulkcloseservicerequests', 'Allow user to close service requests in bulk', 'Allow user to close service requests in bulk', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8cancelsr', 'Cancel service requests', 'Cancel service requests', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8canreopensr', 'Can re-open service request', 'Can re-open service request', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8closemr', 'Close make ready', 'Close make ready', 13, 9, 82, 82, @UserId, GETDATE())
    	 ,('8editasset', 'Edit and view asset records', 'Edit and view asset records', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8editclosedwo', 'Edit closed work order', 'Edit closed work order', 13, 9, 82, 82, @UserId, GETDATE())
         ,('8editemergency', 'Allow editing of emergency contact information on callcenter setup', 'Allow editing of emergency contact information on callcenter setup', 13, 9, 82, 82, @UserId, GETDATE())
     	 ,('8editSRcompletedate', 'Can enter service request complete date', 'Can enter service request complete date', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8editSRLocation', 'Can edit service request location', 'Can edit service request location', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8edittimesheets', 'Edit time sheets for all technicians', 'Edit time sheets for all technicians', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8edmr', 'Edit and view make ready requests', 'Edit and view make ready requests', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8edsr', 'Edit and view service requests', 'Edit and view service requests', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8edsronholddate', 'Edit on hold dates of service requests', 'Edit on hold dates of service requests', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8edwrkgrps', 'Edit manage work groups', 'Edit manage work groups', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8entersrwithfuturedate', 'Can enter service requests with future dates', 'Can enter service requests with future dates', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8manageassets', 'Can manage assets', 'Can manage assets', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8ManageOpsUsers', 'Ability to manage Ops users', 'Ability to manage Ops users', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8reports', 'Facilities reports', 'Facilities reports', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8undomakeready', 'Undo Make Ready', 'Undo Make Ready', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8uploadCompanyLogo', 'Ability to manage company/site logo for service requests', 'Ability to manage company/site logo for service requests', 13, 9, 82, 82, @UserId, GETDATE())
	     ,('8vwallsr', 'Can view all service requests **ONLY USED IN ONESITE MOBILE SERVICE REQUESTS', 'Can view all service requests **ONLY USED IN ONESITE MOBILE SERVICE REQUESTS', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8vwasset', 'View asset records', 'View asset records', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8vwmr', 'View make ready', 'View make ready', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8vwsr', 'View service requests', 'View service requests', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8WGBillToResident', 'Allow technicians to bill charges to residents', 'Allow technicians to bill charges to residents', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('89editwarrantytemplate', 'Ability to create and edit a warranty template', 'Ability to create and edit a warranty template', 13, 9, 82, 82, @UserId, GETDATE())
		 ,('8closesr', 'Close service requests', 'Close service requests', 13, 9, 82, 82, @UserId, GETDATE())
END
