...
SET @OrganizationName = 'PROMETHEUS REAL ESTATE GROUP, INC.'; --Put PMC Name Here
SET @BlueBookId = '6668'; --Put BlueBookId Here
...
INSERT INTO @ProductList(ProductID)
VALUES(10); -- Prospect Contact Center
INSERT INTO @ProductList(ProductID)
VALUES(13); -- Spend Management (Ops)
INSERT INTO @ProductList(ProductID)
VALUES(14); -- ClientPortal
INSERT INTO @ProductList(ProductID)
VALUES(15); -- Renters Insurance
INSERT INTO @ProductList(ProductID)
...
SET @fname = 'PrometheusSU01';
SET @MName = '';
SET @Lname = '';
SET @Title = '';
SET @Suffix = '';
SET @Email = 'PrometheusSU01@test.com';
SET @now = GETUTCDATE();
