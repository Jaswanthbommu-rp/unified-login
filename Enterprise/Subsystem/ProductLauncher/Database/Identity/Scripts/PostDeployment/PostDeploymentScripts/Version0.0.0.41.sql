...
SET @DBName = 'Identity';
IF(@ServerName IN ('RCQUSODBSQL001',  'RCPGBKDBSQL005A', 'RCPGBKDBSQL005B')
   AND @DBName = 'Identity')
    BEGIN
...
SET @OrganizationName = 'WINN RESIDENTIAL LIMITED PARTNERSHIP'; --Put PMC Name Here
SET @BlueBookId = '4449'; --Put BlueBookId Here
...
INSERT INTO @ProductList(ProductID)
VALUES(9);  -- Websites & Syncication (MarketingCenter)
...
INSERT INTO @ProductList(ProductID)
VALUES(14); -- ClientPortal
--INSERT INTO @ProductList ( ProductID ) VALUES ( 15 ) -- Renters Insurance
INSERT INTO @ProductList(ProductID)
VALUES(16); -- Vendor Services (Compliance Depot)
INSERT INTO @ProductList(ProductID)
VALUES(17); -- Resident Portal (ActiveBuilding)
...
--INSERT INTO @ProductList ( ProductID ) VALUES ( 24 ) -- BlackBook (Internal only!)
...
EXEC sys.sp_updateextendedproperty @name=N'Build', @value='42'
