...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 1)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 2)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 3)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 4)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 5)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 6)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[Comparator] WHERE ComparatorId = 13)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 1)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 2)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 3)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 4)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 5)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 6)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 7)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 8)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[SameSiteValue] WHERE [SameSiteValueId] = 9)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[LogicalOperator] WHERE [LogicalOperatorId] = 1)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[LogicalOperator] WHERE [LogicalOperatorId] = 2)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[LogicalOperator] WHERE [LogicalOperatorId] = 3)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[LogicalGroup] WHERE [LogicalGroupId] = 2)
...
IF EXISTS (SELECT 1 FROM [Enterprise].[LogicalGroup] WHERE [LogicalGroupId] = 3)
