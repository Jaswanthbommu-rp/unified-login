...
-- Add product icons to the product settings / product config / configuration / and global configuration tables
BEGIN TRAN;

DECLARE @productSettingTypeId as int;
...
ELSE
BEGIN
	SET @productSettingTypeId = (SELECT TOP 1 ProductSettingTypeId FROM Enterprise.ProductSettingType WHERE [Name] = 'ProductIcon');
END

DECLARE @productIconMap as table (ProductId int, Icon varchar(MAX));
INSERT INTO @productIconMap VALUES
(1, 'onesite'),
(2, 'unified-ui'),
(3, 'unified-platform'),
...
(19, 'learning-portal'),
(20, 'realpage-document-management'),
(21, 'leasing-and-rent-conversion-tool'),
(22, 'rentjoy'),
(23, 'on-site'),
...
(36, 'easy-lms'),
(37, 'property-photos'),
(38, 'vendor-marketplace'),
(39, 'integration-marketplace'),
(40, 'intelligent-lead-management'),
(41, 'ilm-leasing-analytics'),
(44, 'portfolio-asset-management'),
(45, 'cimpl'),
(47, 'deposit-iq'),
(48, 'payments'),
(49, 'help-center'),
(50, 'senior-lead-management'),
(51, 'lro'),
(52, 'amenity-analytics'),
(53, 'ai-revenue-management'),
(54, 'rent-control'),
(55, 'renovation-manager'),
(57, 'intelligent-building-trash'),
(58, 'intelligent-building-energy'),
(59, 'intelligent-building-water'),
(60, 'resident-services'),
(62, 'product-updates'),
(63, 'hots'),
(64, 'video-call-laptop'),
(65, 'self-guided-tour'),
(66, 'marketing-analytics'),
(68, 'lease-labs');

MERGE INTO Enterprise.ProductSetting t
	USING @productIconMap s on s.ProductId = t.ProductId
		AND t.ProductSettingTypeId = @productSettingTypeId
	WHEN NOT MATCHED BY TARGET THEN
		INSERT (ProductId, ProductSettingTypeId, [Value], FromDate, ThruDate)
		VALUES (s.ProductId, @productSettingTypeId, s.Icon, GETUTCDATE(), NULL);

DECLARE @currentProductSettingId int;
DECLARE @currentConfigurationId int;

SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 1);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
	VALUES (GETUTCDATE());

	SET @currentConfigurationId = SCOPE_IDENTITY();

	INSERT INTO Enterprise.ProductConfiguration (ConfigurationId, ProductSettingId, FromDate, ThruDate)
	VALUES (@currentConfigurationId, @currentProductSettingId, GETUTCDATE(), NULL);
END

SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 2);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 3);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 4);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 5);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 6);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 7);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 8);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 9);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 10);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 11);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 12);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 13);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 14);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 15);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 16);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 17);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 18);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 19);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 20);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 21);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 22);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 23);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 24);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 25);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 26);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 27);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 28);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 29);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 30);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 31);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 32);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 33);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 34);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 35);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 36);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 37);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 38);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 39);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 40);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 41);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 44);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 45);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 47);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 48);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 49);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 50);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 51);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 52);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 53);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 54);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 55);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 57);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 58);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 59);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 60);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 62);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 63);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 64);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 65);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 66);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
SET @currentProductSettingId = (SELECT TOP 1 ProductSettingId FROM Enterprise.ProductSetting WHERE ProductSettingTypeId = @productSettingTypeId AND ProductId = 68);
IF NOT EXISTS (SELECT TOP 1 * FROM Enterprise.ProductConfiguration
	WHERE ProductSettingId = @currentProductSettingId)
BEGIN
	INSERT INTO Enterprise.[Configuration](CreateDate)
...
MERGE INTO Enterprise.GlobalProductConfiguration t
	USING (SELECT pc.ConfigurationId, ps.ProductId
		FROM @productIconMap pim
			INNER JOIN Enterprise.ProductSetting ps on ps.ProductSettingTypeId = @productSettingTypeId
				AND ps.ProductId = pim.ProductId
			INNER JOIN Enterprise.ProductConfiguration pc on pc.ProductSettingId = ps.ProductSettingId) s
			ON t.ConfigurationId = s.ConfigurationId
				AND t.ProductId = s.ProductId
	WHEN NOT MATCHED BY TARGET THEN
		INSERT (ConfigurationId, ProductId, FromDate, ThruDate)
		VALUES (s.ConfigurationId, s.ProductId, GETUTCDATE(), NULL);
