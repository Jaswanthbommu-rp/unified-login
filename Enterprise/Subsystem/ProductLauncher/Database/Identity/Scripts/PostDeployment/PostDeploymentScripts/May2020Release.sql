...
IF EXISTS ( SELECT * FROM sys.objects WHERE   object_id = OBJECT_ID(N'Enterprise.ListULMappingUserIdForProductUserId') AND type IN ( N'P', N'PC' ) ) 
Begin
	DROP PROCEDURE Enterprise.ListULMappingUserIdForProductUserId;
End;
Go
