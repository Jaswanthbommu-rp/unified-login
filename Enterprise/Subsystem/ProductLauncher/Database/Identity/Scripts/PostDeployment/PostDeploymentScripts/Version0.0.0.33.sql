...
select * from enterprise.productsetting ps where ps.ProductSettingTypeId = 6
select * from enterprise.productsetting ps inner join enterprise.ProductSettingType pst on ps.ProductSettingTypeId = pst.ProductSettingTypeId where productid = 1 and ps.ThruDate is null order by ps.ProductSettingTypeId
select * from enterprise.ProductSettingType
*/

-- Step 1 - In case product type is missing, add one

IF NOT EXISTS(SELECT 1 FROM Enterprise.ProductType WHERE Name = 'On-Site' AND ProductTypeId = 307 )
BEGIN
	INSERT INTO Enterprise.ProductType ( ProductTypeId, ParentProductTypeId, Name, Description)
		values
			(307, 300, 'On-Site', 'On-Site' ) 
END

--step 2 - add product
IF NOT EXISTS(SELECT 1 FROM Enterprise.Product WHERE Name = 'On-Site')
BEGIN
	INSERT INTO Enterprise.Product (ProductId, ProductGUID,       Name, Description, ProductTypeId)
	VALUES (23, '0F7C11A0-7533-4C77-8F91-729BA1EE6BAA',  'On-Site', 'On-Site', 307)
END
...
BEGIN
	...
	BEGIN
		...
		VALUES 
			(@ProductId, 'https://staging2.on-site.com/web/session', 'EF26FEC08C554976572E8A9767DDA437AC452CF6', 'productUsername' )
	END
	...
	EXEC Enterprise.CreateProductSetting
		...
		@Value = '3431c19ab693ead1bfe2a138e2a220f3d96c6e24d3c4547236c9f7b52cb0d4e5',                               -- nvarchar(1000)
	...
	EXEC Enterprise.CreateProductSetting
		@ProductId = @ProductId,                             -- int
		@ProductSettingTypeId = @ProductSettingTypeId,                  -- int
		@Value = N'5E10D43B-AF05-48EF-B365-2084277C106E',                               -- nvarchar(1000)
		@FromDate = @FromDate,          -- datetime
		@ThruDate = NULL,          -- datetime
		@ProductSettingId = @ProductSettingId OUTPUT -- int
	...
	EXEC Enterprise.CreateProductSetting
		@ProductId = @ProductId,                             -- int
		@ProductSettingTypeId = @ProductSettingTypeId,                  -- int
		@Value = N'/product/onsite',                               -- nvarchar(1000)
		@FromDate = @FromDate,          -- datetime
		@ThruDate = NULL,          -- datetime
		@ProductSettingId = @ProductSettingId OUTPUT -- int
	...
	EXEC Enterprise.CreateProductSetting
		@ProductId = @ProductId,                             -- int
		@ProductSettingTypeId = @ProductSettingTypeId,                  -- int
		@Value = N'https://staging9.on-site.com/api/greenbook',                               -- nvarchar(1000)
		@FromDate = @FromDate,          -- datetime
		@ThruDate = NULL,          -- datetime
		@ProductSettingId = @ProductSettingId OUTPUT -- int
	...
	EXEC Enterprise.CreateProductSetting
		@ProductId = @ProductId,                             -- int
		@ProductSettingTypeId = @ProductSettingTypeId,                  -- int
		@Value = N'f3865f8b7c1a2177b0147f2ab1bb3ccfee25f716f883eb341d700986a61d4048',                               -- nvarchar(1000)
		@FromDate = @FromDate,          -- datetime
		@ThruDate = NULL,          -- datetime
		@ProductSettingId = @ProductSettingId OUTPUT -- int
	...
	EXEC Enterprise.CreateProductSetting
		@ProductId = @ProductId,                             -- int
		@ProductSettingTypeId = @ProductSettingTypeId,                  -- int
		@Value = N'https://staging9.on-site.com/oauth/token',                               -- nvarchar(1000)
		@FromDate = @FromDate,          -- datetime
		@ThruDate = NULL,          -- datetime
		@ProductSettingId = @ProductSettingId OUTPUT -- int
...
EXEC sys.sp_updateextendedproperty @name=N'Build', @value='34'