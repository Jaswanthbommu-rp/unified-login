...
SET @OrganizationName = 'Alliance'; --Put PMC Name Here
SET @BlueBookId = '3945'; --Put BlueBookId Here
...
/*CREATE PERSON*/
IF NOT EXISTS ( SELECT TOP 1 1 FROM Ident.UserLogin where LoginName = @Email)
BEGIN
...
EXEC sys.sp_updateextendedproperty @name=N'Build', @value='41'