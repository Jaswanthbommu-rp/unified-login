...
/*
To delete and Organization: Modify the PartyId and Name in the JSON below.
...
FROM		Enterprise.Organization eo
				INNER JOIN OPENJSON (@ProductionEnterpriseOrganizationJSON)
				WITH
				(
					PartyID bigint '$.PartyId',
					Name nvarchar(150) '$.Name'
				) peo ON (eo.Name = peo.Name)
