IF EXISTS (SELECT top 1 1 FROM sys.procedures where object_id =object_id('[Enterprise].[DeleteContactMechanismPreference]'))
DROP PROCEDURE [Enterprise].[DeleteContactMechanismPreference]
GO
