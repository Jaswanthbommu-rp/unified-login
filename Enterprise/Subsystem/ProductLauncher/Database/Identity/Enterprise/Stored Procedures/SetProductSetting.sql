...
BEGIN      
 BEGIN TRY        
  BEGIN TRAN;      
   ...
   select top 1 @TempSettingId=ProductSettingId from Enterprise.ProductSetting where ProductSettingTypeId = @ProductSettingTypeId     
   ...
   begin    
    ...
    set ThruDate = @now    
    where ProductSettingId=@ProductSettingId and ConfigurationId=@ConfigurationId    
   END    
