...
-- =============================================
CREATE PROCEDURE [UserManagement].[GetControlByControlDependencyOnControlDependencyId] (
...
BEGIN
	...
	On
		[UserManagement].[ControlDependency].[ControlDependencyId] = [UserManagement].[Control].[ControlId]
	WHERE
