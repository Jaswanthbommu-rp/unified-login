...
-- =============================================
CREATE PROCEDURE [UserManagement].GetControlByProductPageControlOnProductPageControld (
@ProductPageControld INT
)
AS
...
BEGIN
	...
	On
		[UserManagement].[ProductPageControl].[ProductPageControlId] = [UserManagement].[Control].[ControlId]
	WHERE
		[UserManagement].[ProductPageControl].[ProductPageControlId] = @ProductPageControld
