...
-- =============================================
CREATE PROCEDURE [UserManagement].GetControlByTabTypeControlOnTabTypeControlId (
...
BEGIN
	...
	On
		[UserManagement].[TabTypeControl].[TabTypeControlId] = [UserManagement].[Control].[ControlId]
	WHERE
