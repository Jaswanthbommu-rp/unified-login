...
-- =============================================
CREATE PROCEDURE [UserManagement].SearchTabTypeControlDependency (
...
BEGIN
	...
	AND
		(@ControlTypeValue IS NULL OR [ControlTypeValue] = @ControlTypeValue OR CHARINDEX(@ControlTypeValue,[ControlTypeValue]) > 0)
	AND
