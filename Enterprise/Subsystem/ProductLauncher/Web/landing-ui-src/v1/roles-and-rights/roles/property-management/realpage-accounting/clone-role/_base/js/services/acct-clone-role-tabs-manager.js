...
(function(angular, undefined) {
    ...
    function AcctCloneRoleTabsManager($rootScope, timeout, pubsub, tabsData, tabsMenu, aside, cloneRoleModel, cloneRoleSvc, user, cloneTabsContext,persona) {
        var svc = this,
        ...
        svc.cloneRole = function() {
            ...
            var data = {
                ...
                "inheritedRoleName": cloneRoleModel.data.roleName
            };
        ...
        svc.onCloneRoleError = function(resp) {
            pubsub.publish("osaSettings.cloneRoleError", resp.data);
        };
        ...
        svc.onUpdateSuccess = function() {
            ...
            if (svc.reqCount === svc.reqSuccessCount) {
                aside.hide();
                svc.resetCounts();
                pubsub.publish("acctSettings.cloneRole");
            }
        };
    ...
    angular
        .module("settings")
        .service("acctCloneRoleTabsManager", [
            "$rootScope",
            "timeout",
            "pubsub",
            "acctCloneTabsData",
