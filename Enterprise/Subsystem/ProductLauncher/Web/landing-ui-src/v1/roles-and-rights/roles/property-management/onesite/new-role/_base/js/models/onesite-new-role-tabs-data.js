...
(function(angular, undefined) {
    ...
    function OnesiteNewRoleTabsData($filter) {
        ...
        svc.data = data = {
            rights: {
                ...
                isActive: true,
                text: "Rights",
                incUrl: "roles-and-rights/roles/property-management/onesite/new-role/rights/templates/onesite-rights-tab.html"
            }
    ...
    angular
        .module("settings")
        .service("OnesiteNewRoleTabsData", [
            "$filter",
