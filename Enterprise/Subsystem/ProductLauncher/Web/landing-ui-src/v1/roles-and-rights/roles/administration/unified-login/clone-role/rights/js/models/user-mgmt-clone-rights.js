...
(function(angular, undefined) {
    ...
    function factory(
        ...
        model.getSelectedRightsData = function() {
        ...
        model.getConsolidatedRights = function(allSelRights, selRightsGrid) {
           // empty deselected
           selRightsGrid.deselected = [];     
           //empty selected and add new selected
           selRightsGrid.selected = [];
           allSelRights.forEach(function (item) {
               if(!selRightsGrid.selected[item.id]){
                    selRightsGrid.selected.push(item.id);
               }
           }); 
    ...
    angular
        .module("settings")
        .factory("userMgmtCloneRightsModel", [
