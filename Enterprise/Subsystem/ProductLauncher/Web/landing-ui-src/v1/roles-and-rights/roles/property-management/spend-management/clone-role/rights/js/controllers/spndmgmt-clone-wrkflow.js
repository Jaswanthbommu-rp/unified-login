...
(function(angular, undefined) {
    ...
    function SpndMgmtCloneWrkFlCtrl(
        $scope,
        pubsub,        
        model,       
        tabsManager,
        ...
        vm.init = function() {
            ...
            vm.formWatch = $scope.$watch("cloneWfTabForm", vm.setForm);
    ...
    angular
        .module("settings")
        .controller("SpndMgmtCloneWrkFlCtrl", [
            "$scope",
            "pubsub",            
            ...
            "userSessionModel",
            "personaDetails",
            "spndmgmtCloneRoleWrkFloFormConfig",
            "spndmgmtCloneRoleWfModel",
            "spndmgmtCloneTabsContext",
            SpndMgmtCloneWrkFlCtrl
        ]);
})(angular);