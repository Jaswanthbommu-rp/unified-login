...
(function(angular, undefined) {
    ...
    function OnesiteCloneRoleCtrl(
        ...
        vm.init = function() {
            ...
            vm.errorWatch = pubsub.subscribe("osSettings.cloneRoleError", vm.onError);
        };
    ...
    angular
        .module("settings")
        .controller("OnesiteCloneRoleCtrl", [
            "$scope",
            ...
            "onesiteCloneRoleFormConfig",
            "productsData",
            "onesiteCentersProductsSvc",
            "routeSecurity",
            "personaDetails",
            OnesiteCloneRoleCtrl
        ]);
})(angular);
