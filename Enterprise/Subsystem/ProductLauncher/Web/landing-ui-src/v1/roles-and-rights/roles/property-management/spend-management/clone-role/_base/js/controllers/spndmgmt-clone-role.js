...
(function(angular, undefined) {
    ...
    function SpndMgmtCloneRoleCtrl(
        $scope,
        model,
        pubsub,
        tabsData,
        ...
        vm.init = function() {
            ...
            vm.errorWatch = pubsub.subscribe("smSettings.cloneRoleError", vm.onError);
        };
    ...
    angular
        .module("settings")
        .controller("SpndMgmtCloneRoleCtrl", [
            "$scope",
