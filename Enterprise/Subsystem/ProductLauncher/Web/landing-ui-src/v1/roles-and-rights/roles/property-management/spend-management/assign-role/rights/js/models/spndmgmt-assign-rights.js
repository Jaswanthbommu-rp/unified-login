...
(function(angular, undefined) {
    ...
    function factory(
        ...
        var model = { searchRightName: "" };

        model.init = function() {
            model.existAssignedData = [];
            // model.newAssigned = [];
            // model.unAssignedData = [];
            return model;
        };
        ...
        model.setDisabled = function(data) {
                        
            data.records.forEach(function(grp) {
                grp.subGroupList.forEach(function(subGrp) {
                    subGrp.rightsList.forEach(function(right) {
                        if (right != undefined ) {
                            angular.extend(right, {
                                isDisabled: model.hasViewAccess() ? true : false
                            });                            
                        }
                    });
                });
        ...
        model.getAllUnAssignedData = function() {
            ...
            model.getData().records.forEach(function(grp) {
                grp.subGroupList.forEach(function(subGrp) {
                    subGrp.rightsList.forEach(function(right) {
                        if (right != undefined && (right.isAssigned === false || right.isWarnAssigned === false)) {
                            allUnAssigned.push(right);
                        }
                    });
                });
            });
    ...
    angular
        .module("settings")
        .factory("spndmgmtAssignRightsModel", [
