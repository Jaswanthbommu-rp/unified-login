...
(function(angular, undefined) {
    ...
    function OnesiteAssignRightsCtrl(
        $scope,
        pubsub,
        gridConfig,
        model,
    ...
    angular
        .module("settings")
        .controller("OnesiteAssignRightsCtrl", [
            "$scope",
            "pubsub",
            "onesiteAssignRightsConfig",
            "onesiteAssignRightsModel",
            "onesiteAssignRightsSvc",
