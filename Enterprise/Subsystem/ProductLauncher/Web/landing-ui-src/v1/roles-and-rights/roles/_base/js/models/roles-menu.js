...
(function(angular, undefined) {
    ...
    function factory(sideMenuModel,
        ProductFamiliesData,
        productsModel) {
        function RolesMenuModel() {
            var s = this;
            s.init();
        }

        var p = RolesMenuModel.prototype;
        ...
        p.getLink = function(famName, title) {
            var s = this;
            var link = "roles-and-rights/roles/" + famName + "/" + title + "/index.html";
            link = title === undefined ? "roles-and-rights/roles/coming-soon/templates/index.html" : link;
            return link;
        };
        ...
        return new RolesMenuModel();
    }

    angular
        .module("settings")
        .factory("rolesMenuModel", ["solSideMenuModel", "productFamiliesData", "rolesAndRightsProductsModel", factory]);
})(angular);