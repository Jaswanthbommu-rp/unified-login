...
(function(angular, undefined) {
    ...
    function factory(
        ...
        model.init = function() {
            model.loadModal();
            model.userMgmtNewRole = pubsub.subscribe("userMgmtSettings.newRole", model.updateGrid);
            model.userMgmtEditRole = pubsub.subscribe("userMgmtSettings.editRole", model.updateGrid);
            model.userMgmtEntRoles = pubsub.subscribe("userMgmtSettings.entRoles", model.updateGrid);
            model.userMgmtCloneRole = pubsub.subscribe("userMgmtSettings.cloneRole", model.updateGrid);
            model.userMgmtDeleteRole = pubsub.subscribe("userMgmtSettings.deleteRole", model.updateGrid);
            model.userMgmtDefaultRole = pubsub.subscribe("userMgmtSettings.defaultRole", model.updateGrid);
        ...
        model.loadModal = function() {
            model.deleteRolesModal = $modal({
                show: false,
                placement: "center",
                templateUrl: "roles-and-rights/roles/administration/unified-login/base/templates/delete-roles.html",
                backdrop: true,
                controller: "UserMgmtDeleteModalCtrl",
                controllerAs: "ctrl"
            });
            ...
            model.deleteRoleModal = $modal({
                show: false,
                placement: "center",
                templateUrl: "roles-and-rights/roles/administration/unified-login/base/templates/delete-role.html",
                backdrop: true,
                controller: "UserMgmtDeleteModalCtrl",
                controllerAs: "ctrl"
            });
            ...
            model.warningRolesModal = $modal({
                show: false,
                placement: "center",
                templateUrl: "roles-and-rights/roles/administration/unified-login/base/templates/delete-warning.html",
                backdrop: true,
                controller: "UserMgmtDeleteModalCtrl",
                controllerAs: "ctrl"
            });
            ...
            model.defaultWarningModal = $modal({
                show: false,
                placement: "center",
                templateUrl: "roles-and-rights/roles/administration/unified-login/base/templates/default-warning.html",
                backdrop: true,
                controller: "UserMgmtDeleteModalCtrl",
                controllerAs: "ctrl"
            });
            ...
            model.notSelectedRolesModal = $modal({
                show: false,
                placement: "center",
                templateUrl: "roles-and-rights/roles/administration/unified-login/base/templates/not-selected.html",
                backdrop: true,
                controller: "UserMgmtDeleteModalCtrl",
                controllerAs: "ctrl"
            });
        ...
        model.getDataSvc = function() {
            ...
            var params = {
                userPersonaId: user.getPersonaId(),
                ...
                selRoles.selected.forEach(function(role) {
                    ...
                    if (selObj.length > 0) {
                        ...
                        selObj.forEach(function(roleObj) {
                            if ((roleObj.id === role) && (roleObj.roletype.toLowerCase() === "system")) {
        ...
        model.onDeleteRoleSuccess = function(resp) {
            pubsub.publish("userMgmtSettings.deleteRole");
        };

        model.onDelRoleError = function(resp) {
            logc(resp);
        };
        ...
        model.deleteRole = function(role, delSvc) {
            ...
            delSvc.save(data, {}).$promise
                .then(model.onDeleteRoleSuccess, model.onDelRoleError);

        };

        model.setUserDefault = function (role, defSvc) {
            var data = {
                "editorPersonaId": persona.getId(),
                "roleId": role.id
            };

            defSvc.save(data, {}).$promise
                .then(model.onSetDefRoleSuccess, model.onSetDefRoleError);
        };

        model.onSetDefRoleSuccess = function(resp) {
            pubsub.publish("userMgmtSettings.defaultRole");
        };

        model.onSetDefRoleError = function(resp) {
        ...
        model.onDelRoleSuccess = function(resp) {
            pubsub.publish("userMgmtSettings.deleteRole");
        };
        ...
        model.reset = function() {
            model.grid.destroy();
            model.gridPagination.destroy();
            model.userMgmtNewRole();
            model.userMgmtEditRole();
            model.userMgmtEntRoles();
            model.userMgmtCloneRole();
            model.userMgmtDeleteRole();
            model.userMgmtDefaultRole();
        };
