...
(function(angular, undefined) {
    ...
    function OnesiteNewRoleCtrl(
        ...
        vm.init = function() {
            ...
            vm.errorWatch = pubsub.subscribe("osSettings.newRoleError", vm.onError);
        };
        ...
        vm.cancel = function() {
            pubsub.publish("newRoleOnesite.cancel");
        };
        ...
        vm.create = function() {
            ...
            if (vm.form.$valid) {
                pubsub.publish("newRoleOnesite.update");
            } else {
    ...
    angular
        ...
        .controller("OnesiteNewRoleCtrl", [
            ...
            "onesiteNewRoleTempModel",
            "onesiteNewRoleFormConfig",
            "productsData",
            "routeSecurity",
            "personaDetails",
            OnesiteNewRoleCtrl
