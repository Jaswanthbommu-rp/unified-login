...
(function(angular, undefined) {
    ...
    function AcctAssignRoleTabsManager($rootScope, timeout, pubsub, tabsData, tabsMenu, aside, user, assignRoleModel, AssignRoleSaveSvc, persona) {
        var svc = this,
            triggerID = "AcctAssignRoleTabsManager";
        ...
        svc.assignRole = function() {
            // For Accounting - Name cannot be edited
            // var data = {
        ...
        svc.onCreateRoleError = function(resp) {
            pubsub.publish("settings.osaAssignRoleError", resp.data);
        };
        ...
        svc.onUpdateSuccess = function() {
            ...
            if (svc.reqCount === svc.reqSuccessCount) {
                aside.hide();
                svc.resetCounts();
                pubsub.publish("acctSettings.editRole");
            }
        };
    ...
    angular
        .module("settings")
        .service("acctAssignRoleTabsManager", [
            "$rootScope",
            "timeout",
            "pubsub",
            "acctAssignTabsData",
