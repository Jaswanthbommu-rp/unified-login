...
(function(angular, undefined) {
    ...
    function MCRolesGridCtrl($scope, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, pubsub, persona, MCDataModel) {
        var vm = this,
            rolesGrid = gridModel(),
        ...
        vm.init = function() {
            ...
            pubsub.subscribe("mc.roles-radio", vm.updateRecords);
