	...
	var userPasswordStateModel = function($filter) {
        var form = {},
            keys = {
                char_count_check: {
                    val: "is_in_range",
                    lbl: $filter("userDetailsText")("change_pwd_char_range")
                },
                uppercase_check: {
                    val: "has_capital_letter",
                    lbl: $filter("userDetailsText")("change_pwd_upper_case")
                },
                lowercase_check: {
                    val: "has_small_letter",
                    lbl: $filter("userDetailsText")("change_pwd_lower_case")
                },
                number_check: {
                    val: "has_number",
                    lbl: $filter("userDetailsText")("change_pwd_numerical")
                },
                special_char_check: {
                    val: "has_special_characters",
                    lbl: $filter("userDetailsText")("change_pwd_special_char")
                }
            },
            regex = {
                uppercase_check: /[A-Z]/,
