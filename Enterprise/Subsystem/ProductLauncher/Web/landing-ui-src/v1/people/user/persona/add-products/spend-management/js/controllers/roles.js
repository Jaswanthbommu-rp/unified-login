...
(function(angular, undefined) {
    ...
    function SMRolesGridCtrl($scope, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, pubsub, persona, SMDataModel) {
        var vm = this,
            rolesGrid = gridModel(),
        ...
        vm.init = function() {
            ...
            pubsub.subscribe("cc.roles-radio", vm.updateRecords);
