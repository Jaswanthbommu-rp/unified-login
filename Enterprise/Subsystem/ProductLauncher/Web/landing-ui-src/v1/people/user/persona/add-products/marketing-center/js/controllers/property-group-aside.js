//  Marketing Center Property Ground Aside Controller

(function (angular, undefined) {
    "use strict";

    function MCPropertyGroupAsideCtrl($scope, aside, dataSvc, gridModel, gridConfig, gridTransformSvc, detailsModel, gridPaginationModel) {
        var vm = this,
            asideGrid = gridModel(),
    ...
    angular
        .module("settings")
        .controller("MCPropertyGroupAsideCtrl", [
            "$scope",
            "MCPropertyGroupDetailsAside",
            "MCPropertyGroupAsideSvc",
            "rpGridModel",
            "MCPropertyGroupAsideGridConfig",
            "rpGridTransform",
            "MCPropertyGroupDetailsModel",
            "rpGridPaginationModel",
            MCPropertyGroupAsideCtrl
        ]);
})(angular);
