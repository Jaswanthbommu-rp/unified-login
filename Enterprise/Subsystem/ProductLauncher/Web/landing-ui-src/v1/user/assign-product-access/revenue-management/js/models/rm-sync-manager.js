...
(function (angular, undefined) {
    ...
    function factory(pubsub, security, persona) {
        function RMSyncManager() {
            var s = this;
            s.init();
        }

        var p = RMSyncManager.prototype;
        ...
        p.removeCompanyGroup = function (companyId) {
            ...
            if (!angular.equals({}, s.companyGroupMap)) {
                ...
                pubsub.publish("RMCR.CompanyGroupReset", s.companyGroupList);
            }
        ...
        p.selectedRoleSync = function (key, data) {
            ...
            if (data && data.length > 0) {
                ...
                pubsub.publish("RMCR.CompanySelected", selectedRole);
            }
        ...
        return new RMSyncManager();
    }

    angular
        .module("settings")
        .factory("rmSyncManager", [
            "pubsub",
            "routeSecurity",
            "personaDetails",
            factory
