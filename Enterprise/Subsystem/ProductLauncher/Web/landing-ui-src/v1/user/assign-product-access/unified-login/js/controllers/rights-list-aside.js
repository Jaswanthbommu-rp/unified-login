...
(function(angular, undefined) {
    ...
    function UserMgmtRightsListAsideCtrl($scope, aside, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, rightsModel, userModel, persona) {
        var vm = this,
            asideGrid = gridModel(),
    ...
    angular
        .module("settings")
        .controller("UserMgmtRightsListAsideCtrl", [
            "$scope",
