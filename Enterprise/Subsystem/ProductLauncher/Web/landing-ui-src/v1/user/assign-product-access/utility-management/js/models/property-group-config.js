//  Utility Management Property Group Grid Config Model
...
(function(angular, undefined) {
    ...
    function factory(gridConfig, security, persona) {
        ...
        model.isSelectAllEnabled = function () {
            ...
            {
                isEnabled = persona.data.hasManageUtilityManagementProductAccess;
            }
            return isEnabled;
        };
    ...
    angular
        .module("settings")
        .factory("UtilityManagementPropertyGroupGridConfig", [
            "rpGridConfig",
            "routeSecurity",
            "personaDetails",
            factory
