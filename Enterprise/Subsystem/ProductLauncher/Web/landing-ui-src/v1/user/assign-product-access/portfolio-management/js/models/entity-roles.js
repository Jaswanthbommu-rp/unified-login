...
(function (angular, undefined) {
    ...
    function factory(dropdownModel) {
        function PortfolioManagementEntityRolesDropdownModel() {
            var s = this;
            s.init();
        }

        var p = PortfolioManagementEntityRolesDropdownModel.prototype;
        ...
        return function (data) {
            return (new PortfolioManagementEntityRolesDropdownModel()).setData(data);
        };
    ...
    angular
        .module("settings")
        .factory("portfolioManagementEntityRolesDropdownModel", [
           "rpDropdownModel",
           factory
        ]);
})(angular);
