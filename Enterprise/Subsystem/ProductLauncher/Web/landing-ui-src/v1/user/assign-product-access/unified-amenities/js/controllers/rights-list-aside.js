...
(function (angular, undefined) {
    ...
    function UARightsListAsideCtrl($scope, aside, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, rightsModel, userModel, persona) {
        var vm = this,
            asideGrid = gridModel(),
    ...
    angular
        .module("settings")
        .controller("UARightsListAsideCtrl", [
            "$scope",
            "uaRightsListAside",
            "UARightsListAsideSvc",
            "rpGridModel",
            "UARightsAsideGrigConfig",
            "rpGridTransform",
            "rpGridPaginationModel",
            "unifiedAmenitiesRightsModel",
            "userSessionModel",
            "personaDetails",
            UARightsListAsideCtrl
        ]);
})(angular);
