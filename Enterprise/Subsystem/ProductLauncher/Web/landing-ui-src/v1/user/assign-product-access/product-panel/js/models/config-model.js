...
(function (angular) {
    ...
    function factory() {
        ...
        model.setListAsideConfig = function (config) {
             model.listAsideConfig = config ;
        };

        model.getListAsideConfig = function () {
            return model.listAsideConfig ;
        };

        model.setListAsideDisplayName = function (name) {
             model.listAsideDisplayName = name ;
        };

        model.getListAsideDisplayName = function () {
            return model.listAsideDisplayName ;
        };
