...
(function (angular, undefined) {
    ...
    function BIPropertyListAsideCtrl($scope, aside, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, groupModel, userModel, persona) {
        var vm = this,
            asideGrid = gridModel(),
        ...
        vm.init = function () {
            ...
            vm.subtitle = groupModel.getName();
    ...
    angular
        .module("settings")
        .controller("BIPropertyListAsideCtrl", [
            "$scope",
            "biPropertiesListAside",
            "AssetOptimizationGroupPropertyListSvc",
            "rpGridModel",
            "biPropertiesAsideGridConfig",
            "rpGridTransform",
            "rpGridPaginationModel",
            "biPropertyGroupModel",
            "userSessionModel",
            "personaDetails",
            BIPropertyListAsideCtrl
        ]);
})(angular);
