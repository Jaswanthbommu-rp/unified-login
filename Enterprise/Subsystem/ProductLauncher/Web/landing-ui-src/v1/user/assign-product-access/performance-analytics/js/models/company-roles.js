...
(function (angular, undefined) {
    ...
    function factory(dropdownModel) {
        function PerformanceAnalyticsRolesDropdownModel() {
            var s = this;
            s.init();
        }

        var p = PerformanceAnalyticsRolesDropdownModel.prototype;
        ...
        return function (data) {
            return (new PerformanceAnalyticsRolesDropdownModel()).setData(data);
        };
    }

    angular
        .module("settings")
        .factory("performanceAnalyticsRolesDropdownModel", [
           "rpDropdownModel",
           factory
        ]);
})(angular);
