...
(function(angular, undefined) {
    ...
    function factory(sideMenuModel) {
        ...
        p.init = function() {
            ...
            var list = [{
                    active: true,
                    text: "Production",
                    templateUrl: "user/assign-product-access/unified-login/templates/user-mgmt-production.html"
                },
                {
                    active: false,
                    text: "UAT",
                    templateUrl: "user/assign-product-access/unified-login/templates/user-mgmt-uat.html"
                }
            ];
    ...
    angular
        .module("settings")
        .factory("userMgmtSideMenuConfig", ["rpSideMenuModel", factory]);
})(angular);