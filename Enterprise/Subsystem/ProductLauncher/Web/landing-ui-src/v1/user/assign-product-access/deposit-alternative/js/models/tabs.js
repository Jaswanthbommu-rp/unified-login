//  Resident Portals Tabs Model

(function (angular, undefined) {
    "use strict";

    function factory(tabsMenu, tabsData) {
        function DepositAlternativeTabsModel() {
            var s = this;
            s.init();
        }

        var p = DepositAlternativeTabsModel.prototype;
        ...
        return new DepositAlternativeTabsModel();
    }

    angular
        .module("settings")
        .factory("DepositAlternativeTabsModel", [
            "rpScrollingTabsMenuModel",
            "depositAlternativeTabsData",
            factory
        ]);
})(angular);
