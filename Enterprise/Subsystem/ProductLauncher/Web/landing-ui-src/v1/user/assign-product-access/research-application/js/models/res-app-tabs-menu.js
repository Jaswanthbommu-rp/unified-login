...
(function (angular, undefined) {
    ...
    function factory(tabsMenu, tabsData) {
        function ResAppTabsModel() {
            var s = this;
            s.init();
        }

        var p = ResAppTabsModel.prototype;
        ...
        p.setTabs = function (keys) {
            ...
            keys.forEach(function (key) {
                tabsList.push(tabsData.data[key]);
            });
        ...
        p.activateTab = function (tabKey) {
            ...
            angular.forEach(tabsData.data, function (item, key) {
        ...
        return new ResAppTabsModel();
    }

    angular
        .module("settings")
        .factory("resAppTabsMenuModel", [
