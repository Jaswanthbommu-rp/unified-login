//Aside List Controller

(function(angular, undefined) {
    "use strict";

    function AsideCtrl($scope, aside, dataSvc, gridModel, gridConfig, gridTransformSvc, gridPaginationModel, asideModel, userModel, persona) {
        var vm = this,
            asideGrid = gridModel(),
        ...
        vm.init = function() {
            ...
            vm.subtitle = asideModel.getName();
