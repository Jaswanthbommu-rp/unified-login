...
(function(angular, undefined) {
    ...
    function factory(sideMenuModel) {
        ...
        p.init = function() {
            ...
            var list = [{
                    active: true,
                    text: "Production",
                    templateUrl: "user/assign-product-access/integration-marketplace/templates/user-mgmt-production.html"
                },
                {
                    active: false,
                    text: "UAT",
                    templateUrl: "user/assign-product-access/integration-marketplace/templates/user-mgmt-uat.html"
                }
            ];
    ...
    angular
        .module("settings")
        .factory("integMktSideMenuConfig", ["rpSideMenuModel", factory]);
})(angular);