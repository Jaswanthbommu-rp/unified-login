...
(function (angular, undefined) {
    ...
    function factory(tabsMenu, tabsData) {
        function RentersInsuranceTabsModel() {
            var s = this;
            s.init();
        }

        var p = RentersInsuranceTabsModel.prototype;
        ...
        return new RentersInsuranceTabsModel();
    }

    angular
        .module("settings")
        .factory("RentersInsuranceTabsModel", [
            "rpScrollingTabsMenuModel",
            "rentersInsuranceTabsData",
            factory
        ]);
})(angular);
