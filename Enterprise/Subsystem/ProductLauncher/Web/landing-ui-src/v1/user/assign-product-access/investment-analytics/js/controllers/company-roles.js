...
(function (angular, undefined) {
    ...
    function IACompanyRoleCtrl($scope, $filter, model, sync, iaDataModel) {
        var vm = this;
        ...
        vm.onChange = function (data) {
            ...
            iaDataModel.setCompanyRoles(companyData.roleList);
    ...
    angular
        .module("settings")
        .controller("IACompanyRoleCtrl", [
            "$scope",
            "$filter",
            "investmentAnalyticsRolesDropdownModel",
            "iaSyncManager",
