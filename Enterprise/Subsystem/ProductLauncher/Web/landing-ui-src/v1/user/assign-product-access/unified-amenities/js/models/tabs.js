...
(function (angular, undefined) {
    ...
    function factory(tabsMenu, tabsData) {
        function UnifiedAmenitiesTabsModel() {
            var s = this;
            s.init();
        }

        var p = UnifiedAmenitiesTabsModel.prototype;
        ...
        return new UnifiedAmenitiesTabsModel();
    }

    angular
        .module("settings")
        .factory("UnifiedAmenitiesTabsModel", [
            "rpScrollingTabsMenuModel",
            "unifiedAmenitiesTabsData",
            factory
        ]);
})(angular);
