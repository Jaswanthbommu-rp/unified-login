...
(function (angular, undefined) {
    ...
    function InternalUserModalCtrl($scope, $location, modal, pubsub, persona, model, formConfig, $window, chkEmailModel, userStatus) {
        var vm = this;
    ...
    angular
        .module("settings")
        .controller("InternalUserModalCtrl", [
            "$scope",
            "$location",
            "internalUserModal",
            "pubsub",
