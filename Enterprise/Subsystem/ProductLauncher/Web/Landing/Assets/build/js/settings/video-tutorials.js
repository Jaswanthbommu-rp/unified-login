...
var ShowHideUserSkipToggleNew = function ShowHideUserSkipToggleNew(val) {
...
var ShowHideUserSkipToggle = function ShowHideUserSkipToggle(newUser, migrateUser) {
...
var ShowHideNewUsersRows = function ShowHideNewUsersRows(val) {
    if (val) {
...
$(document).ready(function () {
    ...
    var videoTutorialsGetUrl = videoTutorialsUrl + "?companyId=" + companyId;
...
var LoadVideoDefaulValues = function LoadVideoDefaulValues() {
...
var LoadVideoValues = function LoadVideoValues(response) {
