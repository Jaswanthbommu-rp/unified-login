...
var pikaday = _commonjsHelpers.createCommonjsModule(function (module, exports) {
/*!
 * Pikaday
 *
...
const RaulDatePicker = class {
      ...
      */
                    ...
                    if (this.date.getMonth() === this.activeMonth) {
                        switch (e.key) {
                            case 'ArrowDown':
                                e.preventDefault();
                                //@ts-ignore
                                this.handleDateChange(hooks(this.date).add(1, 'weeks')._d, true);
                                this.hasDate = false;
                                if (this.hasSetADate) {
                                    this.addClassToSelected();
                                }
                            ...
                            case 'ArrowUp':
                                e.preventDefault();
                                //@ts-ignore
                                this.handleDateChange(hooks(this.date).subtract(1, 'weeks')._d, true);
                                this.hasDate = false;
                                if (this.hasSetADate) {
                                    this.addClassToSelected();
                                }
                            ...
                            case 'ArrowLeft':
                                e.preventDefault();
                                //@ts-ignore
                                this.handleDateChange(hooks(this.date).subtract(1, 'days')._d, true);
                                this.hasDate = false;
                                if (this.hasSetADate) {
                                    this.addClassToSelected();
                                }
                            ...
                            case 'ArrowRight':
                                e.preventDefault();
                                //@ts-ignore
                                this.handleDateChange(hooks(this.date).add(1, 'days')._d, true);
                                this.hasDate = false;
                                if (this.hasSetADate) {
                                    this.addClassToSelected();
                                }
                ...
                if (this.view === 'months') {
                    switch (e.key) {
                        case 'ArrowDown':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).add(4, 'months')._d;
                        ...
                        case 'ArrowUp':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).subtract(4, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            // this.hasDate = false
                            break;
                        case 'ArrowLeft':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).subtract(1, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            // this.hasDate = false
                            break;
                        case 'ArrowRight':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).add(1, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            // this.hasDate = false
                            break;
                        case 'Enter':
                ...
                if (this.view === 'years') {
                    switch (e.key) {
                        case 'ArrowDown':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).add(4, 'years')._d;
                        ...
                        case 'ArrowUp':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).subtract(4, 'years')._d;
                            if (this.focusedDate.getFullYear() < this.yearsRangeStart)
                                this.handlePreviousYearsRange();
                            if (this.focusedDate.getFullYear() >= (this.yearsRangeStart + 12))
                                this.handleNextYearsRange();
                        ...
                        case 'ArrowLeft':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).subtract(1, 'years')._d;
                            if (this.focusedDate.getFullYear() < this.yearsRangeStart)
                                this.handlePreviousYearsRange();
                            if (this.focusedDate.getFullYear() >= (this.yearsRangeStart + 12))
                                this.handleNextYearsRange();
                        ...
                        case 'ArrowRight':
                            ...
                            this.focusedDate = hooks(this.focusedDate || this.date).add(1, 'years')._d;
                            if (this.focusedDate.getFullYear() < this.yearsRangeStart)
                                this.handlePreviousYearsRange();
                            if (this.focusedDate.getFullYear() >= (this.yearsRangeStart + 12))
                                this.handleNextYearsRange();
                ...
                if (this.view === 'dates') {
                    switch (e.key) {
                        case 'ArrowLeft':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(1, 'days')._d;
                            ...
                            if (this.startDate && this.endDate) {
                                // ???
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.startDate).subtract(1, 'days')._d;
                        ...
                        case 'ArrowRight':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(1, 'days')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                        ...
                        case 'ArrowUp':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(1, 'weeks')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.activeYear = this.keyboardStartDate.getFullYear();
                            }
                        ...
                        case 'ArrowDown':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(1, 'weeks')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                ...
                if (this.view === 'months') {
                    switch (e.key) {
                        case 'ArrowLeft':
                            e.preventDefault();
                            //@ts-ignore
                            this.focusedDate = hooks(this.focusedDate || this.keyboardStartDate).subtract(1, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(1, 'month')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                // this.activeMonth = this.keyboardStartDate.getMonth()
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                            ...
                            if (this.startDate && !this.endDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(1, 'months')._d;
                                this.handleRangeChange(this.keyboardStartDate, true);
                                // this.activeMonth = this.keyboardStartDate.getMonth()
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                            ...
                            if (this.startDate && !this.endDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.startDate).subtract(1, 'months')._d;
                                this.picker.setStartRange(null);
                                this.picker.setEndRange(null);
                                this.startDate = null;
                                this.endDate = null;
                        ...
                        case 'ArrowRight':
                            e.preventDefault();
                            //@ts-ignore
                            this.focusedDate = hooks(this.focusedDate || this.keyboardStartDate).add(1, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(1, 'months')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                // this.activeMonth = this.keyboardStartDate.getMonth()
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                        ...
                        case 'ArrowUp':
                            e.preventDefault();
                            //@ts-ignore
                            this.focusedDate = hooks(this.focusedDate || this.keyboardStartDate).subtract(4, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(4, 'months')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                // this.activeMonth = this.keyboardStartDate.getMonth()
                                this.activeYear = this.keyboardStartDate.getFullYear();
                            }
                        ...
                        case 'ArrowDown':
                            e.preventDefault();
                            //@ts-ignore
                            this.focusedDate = hooks(this.focusedDate || this.keyboardStartDate).add(4, 'months')._d;
                            this.activeYear = this.focusedDate.getFullYear();
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(4, 'months')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                // this.activeMonth = this.keyboardStartDate.getMonth()
                                this.activeYear = this.keyboardStartDate.getFullYear();
                                return;
                ...
                if (this.view === 'years') {
                    switch (e.key) {
                        case 'ArrowLeft':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(1, 'year')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                //@ts-ignore
                                // this.handleDateChange(moment(this.date).subtract(1, 'years')._d, true)
                            ...
                            if (this.startDate && !this.endDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.startDate).subtract(1, 'year')._d;
                                this.picker.setStartRange(null);
                                this.picker.setEndRange(null);
                                this.startDate = null;
                                this.endDate = null;
                        ...
                        case 'ArrowRight':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(1, 'year')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.focusedDate = this.keyboardStartDate;
                                if (this.focusedDate.getFullYear() < this.yearsRangeStart)
                        ...
                        case 'ArrowUp':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).subtract(4, 'years')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.focusedDate = this.keyboardStartDate;
                                if (this.focusedDate.getFullYear() < this.yearsRangeStart)
                        ...
                        case 'ArrowDown':
                            ...
                            if (!this.startDate) {
                                //@ts-ignore
                                this.keyboardStartDate = hooks(this.keyboardStartDate).add(4, 'years')._d;
                                this.picker.setDate(this.keyboardStartDate, true);
                                this.activeMonth = this.keyboardStartDate.getMonth();
                                this.focusedDate = this.keyboardStartDate;
                                if (this.focusedDate.getFullYear() < this.yearsRangeStart)
        ...
        this.handleYearFocusedKeyDown = e => {
            ...
            switch (e.key) {
                ...
                case 'ArrowLeft':
                    //@ts-ignore
                    this.handleDateChange(hooks(this.date).subtract(1, 'years')._d, true);
                    break;
                case 'ArrowRight':
                    //@ts-ignore
                    this.handleDateChange(hooks(this.date).add(1, 'years')._d, true);
            }
        };
        ...
        this.dateSelected = core.createEvent(this, "dateSelected", 7);
        this.rangeSelected = core.createEvent(this, "rangeSelected", 7);
        this.UNSAFE_dateSelected = core.createEvent(this, "UNSAFE_dateSelected", 7);
    }
    /**
  ...
  */
    ...
    //test
    render() {
        const PickerToggle = () => (core.h("div", { class: {
            ...
            }, ref: el => this.toggle = el, onClick: this.togglePicker, tabindex: !this.disabled && 0, onKeyDown: !this.disabled && (e => {
                if (!this.showPicker && (e.key === 'Enter')) {
                    this.togglePicker();
                }
            }) }, core.h("div", { class: 'r-date-picker__toggle__value' }, this.display), core.h("div", { class: 'r-date-picker__toggle__icon' }, core.h("raul-icon", { icon: 'calendar-2' }))));
        const PickerHeader = () => (core.h("div", null, core.h("div", { class: 'r-date-picker__header' }, core.h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousMonth }), core.h("div", { role: 'button', class: 'r-date-picker__header__month-year-label', onClick: this.handleMonthYearClick, tabindex: 0, onKeyDown: this.handleHeaderKeyDown }, core.h("div", { class: 'r-date-picker__header__month-year-label__focus-utility', tabindex: -1 }, `${this.months[this.activeMonth]} ${this.activeYear}`)), core.h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextMonth }))));
        const DatePicker = () => (core.h("div", { class: {
            ...
            } }, core.h(PickerHeader, null)));
        const MonthPicker = () => (core.h("div", { class: 'r-date-picker__months-view' }, core.h("div", { class: 'r-date-picker__months-view__header' }, core.h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousYear }), core.h("div", { class: 'r-date-picker__months-view__year-label', onClick: this.handleMonthYearClick, tabindex: 0, onKeyDown: this.handleYearFocusedKeyDown }, core.h("div", { class: 'r-date-picker__months-view__year-label__focus-utility' }, this.activeYear)), core.h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextYear })), core.h("div", { class: 'r-date-picker__months-view__months-container', tabindex: 0, onKeyDown: this.handleKeyDown }, this.months.map((month, index) => (core.h("div", { class: {
        ...
        const YearPicker = () => (core.h("div", { class: 'r-date-picker__years-view' }, core.h("div", { class: 'r-date-picker__years-view__header' }, core.h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousYearsRange }), core.h("div", { class: 'r-date-picker__months-view__year-label' }, core.h("div", { class: 'r-date-picker__months-view__year-label__focus-utility', tabindex: -1 }, `${this.yearsRangeStart} - ${this.yearsRangeStart + 11}`)), core.h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextYearsRange })), core.h("div", { class: 'r-date-picker__years-view__years-container', tabindex: 0, onKeyDown: this.handleKeyDown }, Array.from({ length: 12 }).map((_, index) => core.h("div", { class: {
        ...
        return (core.h("div", { ref: el => this.el = el, onKeyDown: e => {
            ...
            } }, this.label && core.h("label", { class: "r-date-picker__label" }, this.label), core.h("div", { class: 'r-date-picker' }, core.h(PickerToggle, null), core.h("div", { class: 'r-date-picker__container__responsive-utility-wrapper' }, core.h("div", { ref: el => this.dropdown = el, class: {
                'r-date-picker__dropdown': true,
                'r-date-picker__dropdown--top': this.top
            } }, core.h(DatePicker, null), this.view === 'months' && core.h(MonthPicker, null), this.view === 'years' && core.h(YearPicker, null)))), this.hint && core.h("small", { class: "r-date-picker__hint" }, this.hint), this.error &&
            core.h("div", { class: "r-date-picker__error" }, core.h("raul-icon", { icon: "interface-alert-diamond", class: "r-date-picker__error__icon" }), " ", this.error)));
    }
