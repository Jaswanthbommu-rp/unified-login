...
const RaulBulkActionBar = class {
    constructor(hostRef) {
        ...
        this.open = false;
        this.showTray = false;
        this.bulkActionsClose = core.createEvent(this, "bulkActionsClose", 7);
        this.bulkActionsSelectAll = core.createEvent(this, "bulkActionsSelectAll", 7);
    }
    openChanged() {
        if (this.open) {
    ...
    render() {
        return (core.h("div", { class: {
            ...
            }, ref: (el) => this.bulkActionEl = el }, core.h("div", { class: "r-bulk-actions__wrapper" }, core.h("div", { class: "r-bulk-actions__left" }, core.h("div", { class: "r-bulk-actions__buttons-wrapper" }, core.h("slot", null)), core.h("div", { class: "r-bulk-actions__more" }, core.h("raul-button", { class: "r-bulk-actions__button-more", variant: "reverse", size: "small", onClick: () => this.toggleTray() }, "More"), core.h("div", { class: {
                'r-bulk-actions__more-tray': true,
                'r-bulk-actions__more-tray--show': this.showTray,
            }, ref: (el) => this.moreTray = el }))), core.h("div", { class: "r-bulk-actions__right" }, core.h("button", { type: "button", class: "r-bulk-actions__select-all", onClick: () => this.bulkActionsSelectAll.emit() }, "Select all ", this.totalRecords, " records"), core.h("span", { class: "r-bulk-actions__selected-count" }, this.selectedCount, " Selected"), core.h("button", { type: "button", class: "r-bulk-actions__close", onClick: () => this.closeBar() }, core.h("raul-icon", { icon: "close" }))))));
    }
...
exports.raul_bulk_action_bar = RaulBulkActionBar;
