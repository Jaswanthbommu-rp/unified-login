...
const RaulTooltip = class {
    ...
    createTooltip() {
        if (!this.popper) {
            ...
            this.popper = new popper.Popper(this.el, this.tooltipRef(), this.popperOptions());
        }
    }
    removeTooltip() {
        if (this.popper) {
