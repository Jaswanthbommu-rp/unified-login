...
const Snackbar = props => {
    ...
    return (core.h("div", { class: 'r-snackbar__container' },
        core.h("div", { class: {
                'r-snackbar__left-bar': true,
                [`r-snackbar__left-bar--${variant}`]: true
            } }),
        core.h("div", { class: 'r-snackbar__content-container' },
            core.h("div", { class: 'r-snackbar__heading' },
                core.h("span", null, heading),
                dismissable &&
                    core.h("div", { class: 'r-snackbar__heading__close-button', onClick: () => onCloseCallback(), role: "button", tabindex: 0, onKeyPress: e => { if (e.key === 'Enter') {
                            onCloseCallback();
                        } } },
                        core.h("raul-icon", { icon: 'close' }))),
            content &&
                core.h("div", { class: 'r-snackbar__content' }, content),
            ctaMessage
                ? ctaUrl ?
                    core.h("a", { href: ctaUrl },
                        core.h("div", { class: 'r-snackbar__cta' }, ctaMessage))
                    :
                        core.h("div", { class: 'r-snackbar__cta__message', role: 'button', tabindex: 0, onKeyPress: e => { if (e.key === 'Enter') {
                                ctaCallback && ctaCallback();
                            } } },
                            core.h("span", { role: 'button', onClick: ctaCallback && (() => ctaCallback()) }, ctaMessage))
                : null)));
};
...
const RaulSnackbar = class {
    ...
    // }
    render() {
        return (core.h(Snackbar, { dismissable: this.dismissable, variant: this.variant, heading: this.heading, content: this.content, ctaMessage: this.ctaMessage, ctaUrl: this.ctaUrl, ctaCallback: this.ctaCallback, onCloseCallback: () => this.dismiss() }));
    }
...
exports.raul_snackbar = RaulSnackbar;
exports.raul_snackbar_group = RaulSnackbarGroup;
exports.raul_toaster = RaulToaster;
