...
const Dot = (props) => core.h("div", { class: "r-container-loader__dot", style: { animationDelay: props.animationDelay } });
const RaulcontainerLoader = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    }
    render() {
        return (core.h("div", { class: 'r-container-loader__container' }, core.h("div", { class: 'r-container-loader__dots-container' }, Array.from({ length: 3 }).map((_, index) => core.h(Dot, { animationDelay: `${index * 333}ms` })))));
    }
...
const RaulPageLoader = class {
    ...
    render() {
        return (core.h("div", { class: 'r-page-loader__container' }, core.h("div", { class: 'r-page-loader__spinner' })));
    }
...
exports.raul_container_loader = RaulcontainerLoader;
exports.raul_page_loader = RaulPageLoader;
