...
const RaulAside = class {
    constructor(hostRef) {
        ...
        this.focused = false;
        this.size = 'medium';
        this.raulAsideOpen = core.createEvent(this, "raulAsideOpen", 7);
        this.raulAsideClose = core.createEvent(this, "raulAsideClose", 7);
    }
    componentDidLoad() {
    ...
    render() {
        return (core.h(core.Host, { visible: this.visible, expanded: this.expanded }, core.h("div", { class: "r-aside", role: "dialog", tabindex: "-1", "aria-hidden": !this.visible, onKeyDown: e => e.key === 'Escape' && this.focused ? this.close() : null, ref: (el) => this.asideEl = el }, core.h("slot", { name: "secondary-aside" }), core.h("div", { class: "r-aside__backdrop", onClick: () => this.close() }), core.h("div", { class: "r-aside__dialog", role: "document", style: { transform: this.secondaryDialogWidth ? `translateX(${this.dialogOffsetX()}px)` : null }, ref: el => this.dialogEl = el }, core.h("slot", null)))));
    }
...
exports.raul_aside = RaulAside;
exports.raul_aside_body = RaulAsideBody;
exports.raul_aside_footer = RaulAsideFooter;
exports.raul_aside_header = RaulAsideHeader;
