...
const _commonjsHelpers = require('./_commonjsHelpers-559125c6.js');
const getDocs = require('./get-docs-60315e07.js');
...
var acorn = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var js$1 = _commonjsHelpers.createCommonjsModule(function (module) {
...
const DocsPreviewProps = class {
    ...
    renderPropControl(doc) {
        ...
        if (type === 'string') {
            return (core.h("raul-input", { label: labelText }, core.h("input", { class: "mb-4", type: "text", value: fallback, onInput: e => emitChange(e.target.value) })));
        }
        if (type === 'boolean') {
            return (core.h("raul-switch", { "label-text": labelText }, core.h("input", { type: 'checkbox', checked: false, onChange: e => emitChange(e.target.checked) })));
        }
        const selectOptions = type.replace(/"/g, '').split(' | ').map(opt => { return { text: opt, value: opt }; });
        if (selectOptions.length > 0) {
            return (core.h("raul-select", { class: "display-block mb-4", label: labelText, options: selectOptions, value: fallback, onRaulChange: e => emitChange(e.detail.value) }));
        }
    }
    render() {
        return (core.h("div", { class: "r-docs-preview-props" }, this.propDocs.map((propDoc) => {
            return this.renderPropControl(propDoc);
        })));
    }
};

const DocsReadme = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    }
    componentWillLoad() {
        this.readme = getDocs.getDocs(this.component).readme;
    }
    render() {
        return (core.h("div", { class: "r-docs-readme page-section" }, core.h("docs-markdown", null, this.readme)));
    }
};

const DocsShowcase = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    }
    render() {
        return (core.h("div", { class: "r-docs-showcase page-section" }, core.h("h2", { id: "examples", class: "text-lg font-bold mb-6" }, "Examples"), core.h("slot", null)));
    }
};

const RaulInput = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    ...
    render() {
        return (core.h("div", { class: {
            ...
            } }, this.label && core.h("label", { class: "r-form-element__label", htmlFor: this.inputId }, this.label), core.h("div", { class: "r-form-element__control" }, core.h("slot", null), this.type === 'search' && core.h("raul-icon", { icon: "search", class: "r-from-element__control__search-icon" })), this.hint && core.h("small", { class: "r-form-element__hint" }, this.hint), this.error &&
