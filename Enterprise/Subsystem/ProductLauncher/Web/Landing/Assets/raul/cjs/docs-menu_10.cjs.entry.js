...
const DocsMenu = class {
    ...
    render() {
        return (core.h(core.Host, { class: this.open ? 'open' : '' }, core.h("div", { class: "r-docs-menu" }, core.h("button", { class: "docs-menu-toggle", onClick: () => this.toggleMenu() }, core.h("span", null), core.h("span", null), core.h("span", null), core.h("span", null)), core.h("docs-menu-section", { name: "Home", url: "/" }), core.h("docs-menu-section", { name: "Overview" }, core.h("docs-menu-page", { name: "Introduction", url: "/overview/introduction" }), core.h("docs-menu-page", { name: "Upgrading", url: "/overview/upgrading" }), core.h("docs-menu-page", { name: "Compliance", url: "/overview/compliance" }), core.h("docs-menu-page", { name: "Accessibility", url: "/overview/accessibility" })), core.h("docs-menu-section", { name: "Theme" }, core.h("docs-menu-page", { name: "Typography", url: "/theme/typography" }), core.h("docs-menu-page", { name: "Colors", url: "/theme/colors" }), core.h("docs-menu-page", { name: "Spacing", url: "/theme/spacing" })), core.h("docs-menu-section", { name: "Components" }, core.h("docs-menu-page", { name: "Overview", url: "/elements/index" }), core.h("docs-menu-elem-page", { name: "Accordion", url: "/elements/accordion" }), core.h("docs-menu-elem-page", { name: "Action menu", url: "/elements/action-menu" }), core.h("docs-menu-elem-page", { name: "Alert", url: "/elements/alert" }), core.h("docs-menu-elem-page", { name: "Aside", url: "/elements/aside" }), core.h("docs-menu-elem-page", { name: "Avatar", url: "/elements/avatar" }), core.h("docs-menu-elem-page", { name: "Badge", url: "/elements/badge" }), core.h("docs-menu-elem-page", { name: "Breadcrumbs", url: "/elements/breadcrumbs" }), core.h("docs-menu-elem-page", { name: "Bulk Action Bar", url: "/elements/bulk-action-bar" }), core.h("docs-menu-elem-page", { name: "Button", url: "/elements/button" }), core.h("docs-menu-elem-page", { name: "Card", url: "/elements/card" }), core.h("docs-menu-elem-page", { name: "Checkbox", url: "/elements/checkbox" }), core.h("docs-menu-elem-page", { name: "Chips", url: "/elements/chips" }), core.h("docs-menu-elem-page", { name: "Date picker", url: "/elements/date-picker" }), core.h("docs-menu-elem-page", { name: "Filter Bar", url: "/elements/filter-bar" }), core.h("docs-menu-elem-page", { name: "Filter menu", url: "/elements/filter-menu" }), core.h("docs-menu-elem-page", { name: "Footer", url: "/elements/footer" }), core.h("docs-menu-elem-page", { name: "Grid", url: "/elements/grid" }), core.h("docs-menu-elem-page", { name: "Input", url: "/elements/input" }), core.h("docs-menu-elem-page", { name: "List", url: "/elements/list" }), core.h("docs-menu-elem-page", { name: "Loaders", url: "/elements/loaders" }), core.h("docs-menu-elem-page", { name: "Modal", url: "/elements/modal" }), core.h("docs-menu-elem-page", { name: "Paging Bar", url: "/elements/paging-bar" }), core.h("docs-menu-elem-page", { name: "Progress", url: "/elements/progress" }), core.h("docs-menu-elem-page", { name: "Radio Button", url: "/elements/radio" }), core.h("docs-menu-elem-page", { name: "Select", url: "/elements/select" }), core.h("docs-menu-elem-page", { name: "Simple Select", url: "/elements/simple-select" }), core.h("docs-menu-elem-page", { name: "Simple Table", url: "/elements/simple-table" }), core.h("docs-menu-elem-page", { name: "Snackbar", url: "/elements/snackbar" }), core.h("docs-menu-elem-page", { name: "Sortables", url: "/elements/sortables" }), core.h("docs-menu-elem-page", { name: "Status", url: "/elements/status" }), core.h("docs-menu-elem-page", { name: "Status Indicator", url: "/elements/status-indicator" }), core.h("docs-menu-elem-page", { name: "Switch", url: "/elements/switch" }), core.h("docs-menu-elem-page", { name: "Tabs", url: "/elements/tabs" }), core.h("docs-menu-elem-page", { name: "Textarea", url: "/elements/textarea" }), core.h("docs-menu-elem-page", { name: "Toggles", url: "/elements/toggles" }), core.h("docs-menu-elem-page", { name: "Tooltip", url: "/elements/tooltip" })))));
    }
...
const DocsMenuElemPage = class {
    ...
    render() {
        return (core.h("docs-menu-page", { name: this.name, url: this.url }));
    }
};
...
const DocsMenuPage = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.menuPageActivated = core.createEvent(this, "menuPageActivated", 7);
    }
    handleClick(e) {
    ...
    render() {
        return (core.h("div", { class: "r-docs-menu__page" }, core.h("stencil-route-link", { "anchor-class": "r-docs-menu__page__link", url: this.url }, this.name)));
    }
...
const DocsMenuSection = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.expanded = false;
        this.expandSection = core.createEvent(this, "expandSection", 7);
    }
    componentDidLoad() {
    ...
    setInitialToggleState() {
        if (this.el.querySelector('.link-active')) {
            this.expanded = true;
            index.expandHeight(this.contentEl, false);
        }
    }
    handleClick(e) {
        if (this.el.contains(e.target)) {
            if (this.expanded) {
                ...
                this.expanded = true;
                index.expandHeight(this.contentEl);
    ...
    maybeCollapse(e) {
        if (e.detail !== this.el) {
            this.expanded = false;
            index.collapseHeight(this.contentEl);
            this.el.classList.remove("open");
        }
    }
    renderSectionTitle() {
        if (this.url) {
            return (core.h("div", { class: "r-docs-menu__section" }, core.h("h4", { onClick: (e) => this.handleClick(e), class: "r-docs-menu__section__name" }, core.h("stencil-route-link", { "anchor-class": "r-docs-menu__header__link", url: this.url }, this.name)), core.h("div", { class: "r-docs-menu__section__content", ref: (el) => this.contentEl = el }, core.h("slot", null))));
        }
        else {
            return (core.h("div", { class: "r-docs-menu__section" }, core.h("h4", { onClick: (e) => this.handleClick(e), class: "r-docs-menu__section__name" }, this.name, core.h("raul-icon", { icon: "arrow-down-v", class: "text-gray-dark" })), core.h("div", { class: "r-docs-menu__section__content", ref: (el) => this.contentEl = el }, core.h("slot", null))));
        }
    }
    render() {
        return (core.h("span", null, this.renderSectionTitle()));
    }
    get el() { return core.getElement(this); }
};
...
const DocsShell = class {
    ...
    render() {
        return (core.h("div", { class: "docs-container" }, core.h("docs-menu", { slot: "navigation" }), core.h("main", { slot: "page" }, core.h("stencil-router", null, core.h("stencil-route-switch", { scrollTopOffset: 0 }, core.h("stencil-route", { url: "/", component: "docs-home", exact: true }), core.h("stencil-route", { url: "/overview/introduction", component: "docs-introduction" }), core.h("stencil-route", { url: "/overview/upgrading", component: "docs-upgrading" }), core.h("stencil-route", { url: "/overview/compliance", component: "docs-compliance" }), core.h("stencil-route", { url: "/overview/accessibility", component: "docs-accessibility" }), core.h("stencil-route", { url: "/theme/typography", component: "docs-typography" }), core.h("stencil-route", { url: "/theme/colors", component: "docs-colors" }), core.h("stencil-route", { url: "/theme/spacing", component: "docs-spacing" }), core.h("stencil-route", { url: "/elements/index", component: "docs-index" }), core.h("stencil-route", { url: "/elements/heading", component: "docs-raul-heading" }), core.h("stencil-route", { url: "/elements/text", component: "docs-raul-text" }), core.h("stencil-route", { url: "/elements/alert", component: "docs-raul-alert" }), core.h("stencil-route", { url: "/elements/button", component: "docs-raul-button" }), core.h("stencil-route", { url: "/elements/checkbox", component: "docs-raul-checkbox" }), core.h("stencil-route", { url: "/elements/radio", component: "docs-raul-radio-button" }), core.h("stencil-route", { url: "/elements/badge", component: "docs-raul-badge" }), core.h("stencil-route", { url: "/elements/modal", component: "docs-raul-modal" }), core.h("stencil-route", { url: "/elements/simple-select", component: "docs-raul-simple-select" }), core.h("stencil-route", { url: "/elements/select", component: "docs-raul-select" }), core.h("stencil-route", { url: "/elements/action-menu", component: "docs-raul-action-menu" }), core.h("stencil-route", { url: "/elements/filter-menu", component: "docs-raul-filter-menu" }), core.h("stencil-route", { url: "/elements/sortables", component: "docs-raul-sortable-list" }), core.h("stencil-route", { url: "/elements/loaders", component: "docs-raul-loaders" }), core.h("stencil-route", { url: "/elements/input", component: "docs-raul-input" }), core.h("stencil-route", { url: "/elements/textarea", component: "docs-raul-textarea" }), core.h("stencil-route", { url: "/elements/tabs", component: "docs-raul-tabs" }), core.h("stencil-route", { url: "/elements/date-picker", component: "docs-raul-date-picker" }), core.h("stencil-route", { url: "/elements/paging-bar", component: "docs-raul-paging-bar" }), core.h("stencil-route", { url: "/elements/bulk-action-bar", component: "docs-raul-bulk-action-bar" }), core.h("stencil-route", { url: "/elements/snackbar", component: "docs-raul-snackbar" }), core.h("stencil-route", { url: "/elements/switch", component: "docs-raul-switch" }), core.h("stencil-route", { url: "/elements/chips", component: "docs-raul-chips" }), core.h("stencil-route", { url: "/elements/status", component: "docs-raul-status" }), core.h("stencil-route", { url: "/elements/status-indicator", component: "docs-raul-status-indicator" }), core.h("stencil-route", { url: "/elements/aside", component: "docs-raul-aside" }), core.h("stencil-route", { url: "/elements/list", component: "docs-raul-list" }), core.h("stencil-route", { url: "/elements/simple-table", component: "docs-raul-simple-table" }), core.h("stencil-route", { url: "/elements/grid", component: "docs-raul-grid" }), core.h("stencil-route", { url: "/elements/filter-bar", component: "docs-raul-filter-bar" }), core.h("stencil-route", { url: "/elements/accordion", component: "docs-raul-accordion" }), core.h("stencil-route", { url: "/elements/avatar", component: "docs-raul-avatar" }), core.h("stencil-route", { url: "/elements/breadcrumbs", component: "docs-raul-breadcrumbs" }), core.h("stencil-route", { url: "/elements/toggles", component: "docs-raul-toggles" }), core.h("stencil-route", { url: "/elements/card", component: "docs-raul-card" }), core.h("stencil-route", { url: "/elements/progress", component: "docs-raul-progress" }), core.h("stencil-route", { url: "/elements/footer", component: "docs-raul-footer" }), core.h("stencil-route", { url: "/elements/tooltip", component: "docs-raul-tooltip" }), core.h("stencil-route", { component: "docs-404" }))))));
    }
...
const RaulIcon = class {
    ...
    render() {
        return (core.h("i", { class: "r-icon", innerHTML: this.svgContent }));
    }
...
exports.docs_menu = DocsMenu;
exports.docs_menu_elem_page = DocsMenuElemPage;
exports.docs_menu_page = DocsMenuPage;
exports.docs_menu_section = DocsMenuSection;
exports.docs_shell = DocsShell;
exports.raul_icon = RaulIcon;
