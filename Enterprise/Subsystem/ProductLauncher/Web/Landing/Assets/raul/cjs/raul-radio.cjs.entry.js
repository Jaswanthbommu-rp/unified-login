...
const RaulRadio = class {
    ...
    render() {
        return (core.h("div", { class: {
            ...
            } }, core.h("label", { class: "r-radio__label" }, core.h("slot", null), core.h("div", { class: "r-radio__label__icon" }), this.labelText &&
            core.h("div", { class: "r-radio__label__text" }, this.labelText))));
    }
