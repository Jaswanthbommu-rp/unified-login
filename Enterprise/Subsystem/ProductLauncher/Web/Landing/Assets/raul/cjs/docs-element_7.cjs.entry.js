...
const index = require('./index-b59dae29.js');
const popper = require('./popper-61fe3735.js');
const _commonjsHelpers = require('./_commonjsHelpers-559125c6.js');
const index$1 = require('./index-1cfd8f32.js');
const index$2 = require('./index-3ac840fc.js');
const getDocs = require('./get-docs-60315e07.js');

const DocsElement = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.activeTab = "overview";
    }
    render() {
        return (core.h("div", { class: "docs-element" }, core.h("div", { class: "docs-page-header tabbed" }, core.h("h1", null, this.title), core.h("raul-tabs", { tabs: [
                { label: "OVERVIEW", name: "overview" },
                { label: "DESIGN GUIDELINES", name: "design" },
                { label: "API", name: "api" },
            ], "active-tab": this.activeTab, onRaulTabChange: (e) => this.activeTab = e.detail })), core.h("div", { class: "p-4 md:p-12" }, core.h("div", { style: { display: this.activeTab === 'overview' ? 'block' : 'none' } }, core.h("slot", { name: "overview" })), core.h("div", { style: { display: this.activeTab === 'design' ? 'block' : 'none' } }, core.h("slot", { name: "design" })), core.h("div", { style: { display: this.activeTab === 'api' ? 'block' : 'none' } }, core.h("slot", { name: "api" })))));
    }
};

const DocsInterface = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    }
    componentWillLoad() {
        this.docs = getDocs.getDocs(this.component);
    }
    render() {
        ...
        const renderNotApplicable = (type) => {
            return (core.h("div", { class: "r-docs-interface__na" }, "No ", type, " available."));
        };
        return (core.h("div", { class: "r-docs-interface page-section" }, core.h("h2", { class: "text-lg font-bold mb-6" }, "Component API"), core.h("div", { class: "r-docs-interface__section page-section" }, core.h("h4", { id: "props", class: "text-sm uppercase font-bold" }, "Props"), this.docs.props.length > 0 &&
            core.h("raul-simple-table", null, core.h("table", null, core.h("thead", null, core.h("tr", null, core.h("th", null, "Name"), core.h("th", null, "Type"), core.h("th", null, "Default"), core.h("th", null, "Description"))), core.h("tbody", null, this.docs.props.map(prop => {
                return (core.h("tr", null, core.h("td", null, prop.name), core.h("td", { style: { maxWidth: '300px' } }, prop.type), core.h("td", null, core.h("code", null, renderDefault(prop.default))), core.h("td", null, prop.docs || '[MISSING]')));
            })))) || renderNotApplicable('properties')), core.h("div", { class: "r-docs-interface__section page-section" }, core.h("h4", { id: "methods", class: "text-sm uppercase font-bold" }, "Methods"), this.docs.methods.length > 0 &&
            core.h("raul-simple-table", null, core.h("table", null, core.h("thead", null, core.h("tr", null, core.h("th", null, "Method"), core.h("th", null, "Description"))), core.h("tbody", null, this.docs.methods.map(method => {
                return (core.h("tr", null, core.h("td", null, core.h("code", null, method.signature)), core.h("td", null, method.docs || '[MISSING]')));
            })))) || renderNotApplicable('methods')), core.h("div", { class: "r-docs-interface__section page-section" }, core.h("h4", { id: "events", class: "text-sm uppercase font-bold" }, "Events"), this.docs.events.length > 0 &&
            core.h("raul-simple-table", null, core.h("table", null, core.h("thead", null, core.h("tr", null, core.h("th", null, "Name"), core.h("th", null, "Description"))), core.h("tbody", null, this.docs.events.map(event => {
                return (core.h("tr", null, core.h("td", null, event.event), core.h("td", null, event.docs || '[MISSING]')));
            })))) || renderNotApplicable('events'))));
    }
    static get style() { return "docs-interface{display:block}.r-docs-interface__section{font-size:14px}.r-docs-interface__section raul-simple-table{width:100%}.r-docs-interface__na{opacity:.5;font-size:14px}"; }
};

const RaulCheckbox = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        /**
...
const RaulOption = class {
    ...
    render() {
        return (core.h(core.Host, { class: {
            ...
            }, role: "option", tabindex: "-1", id: this.optionId, "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : null }, this.icon && core.h("raul-icon", { class: "r-option__icon", icon: this.icon, kind: this.iconKind }), core.h("div", { class: "r-option__text" }, core.h("div", { class: "r-option__text__title", title: this.text }, this.text), this.description && core.h("div", { class: "r-option__text__description", title: this.description }, this.description)), this.multiple
            ? core.h("raul-checkbox", { small: true }, core.h("input", { type: "checkbox", tabindex: "-1", "aria-hidden": "true", checked: this.selected, disabled: this.disabled, value: this.value, ref: el => el && (el.indeterminate = this.indeterminate) }))
            : core.h("raul-icon", { icon: "check-mark-success", class: "r-option__check-mark" })));
    }
};
...
const RaulSelect = class {
    constructor(hostRef) {
         ...
         */
        this.name = `select-${index$2.randomUID()}`;
        /**
         * The text label.
         */
        this.label = null;
        ...
        this.raulSelectOpen = core.createEvent(this, "raulSelectOpen", 7);
        this.raulSelectClose = core.createEvent(this, "raulSelectClose", 7);
    ...
    handleKeyDown(e) {
        if (index$1.NAVIGATION_KEYS.includes(e.key)) {
            e.preventDefault();
            this.opened ? this.focusOption(e.key) : this.open();
        }
        else if (index$1.ESCAPE_KEY.includes(e.key)) {
            this.close();
        }
    }
    ...
    handleDebouncedResize() {
        if (this.opened) {
            index.isScreen('sm') ? this.createPopper() : this.destroyPopper();
        }
    }
    /**
    ...
    processOptions() {
        this.processedOptions = cloneDeep_1(this.options).map((option) => {
            option.id = `option-${index$2.randomUID()}`;
            if (option.options && option.options.length) {
                option.options.forEach((subOption) => {
                    subOption.id = `option-${index$2.randomUID()}`;
                });
            }
            return option;
        });
    ...
    focusOption(key) {
        ...
        if (index$1.DOWN_KEY.includes(key) && !(focusedOptionIndex >= this.focusableOptionsAndGroups().length - 1)) {
            focus('down');
        }
        else if (index$1.UP_KEY.includes(key) && !(focusedOptionIndex <= 0)) {
            focus('up');
        }
    }
    ...
    createPopper() {
        if (!this.popper) {
            this.popper = new popper.Popper(this.toggleButtonEl, this.selectMenuEl, {
    ...
    render() {
        const renderHiddenInput = () => {
            if (this.multiple) {
                return this.value && this.value.length
                    ? this.value.map(value => core.h("input", { type: "hidden", name: this.name, value: value }))
                    : core.h("input", { type: "hidden", name: this.name, value: this.value });
            }
            else {
                return core.h("input", { type: "hidden", name: this.name, value: this.value });
            }
        };
        const renderSelectToggleContent = () => {
            if (!this.hasSlot('select-toggle')) {
                return (core.h("div", { class: {
                    ...
                    } }, core.h("div", { class: "r-select__toggle__content__text" }, this.selectedOptionsText() || this.placeholder), core.h("raul-icon", { icon: "arrow-down-v", class: "r-select__toggle__content__arrow" })));
            }
        };
        const renderSelectMenuFooter = () => {
            if (this.hasSlot('select-menu-footer')) {
                return (core.h("div", { class: "r-select__menu__footer" }, core.h("slot", { name: "select-menu-footer" })));
            }
        };
        const renderSelectMenuMobileLabelContent = () => {
            if (!this.hasSlot('select-mobile-label')) {
                return (core.h("div", { class: "r-select__mobile-label__content" }, core.h("div", { class: "r-select__mobile-label__content__button" }, core.h("span", { onClick: () => this.close() }, "Cancel")), this.label &&
                    core.h("div", { class: "r-select__mobile-label__content__text" }, this.label), this.multiple &&
                    core.h("div", { class: {
                        ...
                        } }, core.h("span", { onClick: () => this.close() }, "Done"))));
            }
        };
        const renderSelectMenuSearch = () => {
            if (this.searchable) {
                return (core.h("div", { class: "r-select__search" }, core.h("raul-icon", { icon: "search", class: "r-select__search__icon" }), core.h("input", { type: "text", class: "r-select__search__input", placeholder: "Search", value: this.searchQuery, onInput: e => this.handleSearch(e), ref: el => this.searchInputEl = el }), this.searchQuery &&
                    core.h("raul-icon", { icon: "remove-2", class: "r-select__search__icon-reset", onClick: () => this.clearSearch() })));
            }
        };
        const renderNoSearchResults = () => {
            if (this.processedOptions.length && !this.visibleOptionsAndGroups().length) {
                return (core.h("div", { class: "r-select__no-search-results" }, "No results found. Try changing your search criteria."));
            }
        };
        const renderSelectMenuHeader = () => {
            return (core.h("div", { class: "r-select__menu__header" }, core.h("div", { class: "r-select__mobile-label" }, renderSelectMenuMobileLabelContent(), core.h("slot", { name: "select-mobile-label" })), renderSelectMenuSearch(), renderNoSearchResults()));
        };
        const renderOption = (option, groupVisible = false, groupDisabled = false) => {
            ...
            if (visible) {
                return (core.h("raul-option", { multiple: this.multiple, selected: selected, focused: focused, disabled: isDisabled, value: value, text: text, description: description, icon: icon, iconKind: iconKind, optionId: id, variant: variant, onClick: e => this.handleOptionChange(e, { id: id, selected: this.multiple ? !selected : true, value }), onKeyDown: e => e.key === 'Enter'
        ...
        const renderOptionsGroup = (group) => {
            ...
            const enabledOptionsSelected = this.multiple
                ...
                : false;
            return (core.h("div", { class: "r-options-group", role: "group" }, core.h("raul-option", { variant: "group", multiple: this.multiple, selected: selected, focused: focused, disabled: disabled, value: value, text: text, description: description, indeterminate: indeterminate, optionId: id, onClick: this.multiple
                    ...
                    : null }), options.map(option => renderOption(option, groupVisible, disabled))));
        };
        return [
            renderHiddenInput(),
            this.label && core.h("label", { class: "r-select__label" }, this.label),
            core.h("div", { class: {
                    'r-select': true,
                    'r-select--opened': this.opened,
                    'r-select--expanded': this.expanded,
                    'r-select--invalid': !!this.error,
                }, ref: el => this.selectEl = el }, core.h("button", { type: "button", class: "r-select__toggle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.opened ? 'true' : 'false', "aria-activedescendant": this.focusedOptionId, onClick: () => this.toggle(), ref: el => this.toggleButtonEl = el }, renderSelectToggleContent(), core.h("slot", { name: "select-toggle" })), this.hint && core.h("small", { class: "r-select__hint" }, this.hint), this.error &&
                core.h("div", { class: "r-select__error" }, core.h("raul-icon", { icon: "interface-alert-diamond", class: "r-select__error__icon" }), " ", this.error), core.h("div", { class: "r-select__menu", ref: el => this.selectMenuEl = el }, core.h("div", { class: "r-select__menu__content" }, renderSelectMenuHeader(), core.h("div", { class: "r-select__menu__body", role: "listbox", tabindex: "-1", "aria-multiselectable": this.multiple ? 'true' : null, style: { maxHeight: this.optionsMaxHeight } }, this.visibleOptionsAndGroups().map(option => {
...
const RaulTabs = class {
    constructor(hostRef) {
         ...
         */
        this.tabs = [];
        this.raulTabChange = core.createEvent(this, "raulTabChange", 7);
    }
    connectedCallback() {
    ...
    render() {
        if (!(this.selectOnMobile && this.xsDevice)) {
            return (core.h("div", { class: "tabs", role: "tablist" }, core.h("div", { class: "tabs__list" }, this.tabs.map(item => {
            ...
            return (core.h("raul-select", { options: this.selectOptions(), value: this.activeTab, onRaulChange: (e) => this.handleRaulChange(e) }));
        }
    }
    static get style() { return "raul-tabs{display:block}raul-tabs .tabs{border-bottom-width:1px;border-color:#ebedee;height:2.5rem;overflow:hidden}raul-tabs .tabs__list{display:-ms-flexbox;display:flex;overflow-x:auto;height:4rem}raul-tabs .tabs__item{-ms-flex:none;flex:none;font-size:.875rem;font-weight:600;border-bottom-width:2px;border-color:transparent;height:2.5rem;padding-left:1rem;padding-right:1rem;margin-top:-1px}raul-tabs .tabs__item:focus{outline:0}raul-tabs .tabs__item:focus,raul-tabs .tabs__item:hover{border-color:#c6ccd0}raul-tabs .tabs__item.tabs__item--active{border-color:#0076cc}raul-tabs .tabs__item.tabs__item--disabled{color:#9ba3a7;pointer-events:none}"; }
};

exports.docs_element = DocsElement;
exports.docs_interface = DocsInterface;
exports.raul_checkbox = RaulCheckbox;
exports.raul_option = RaulOption;
exports.raul_select = RaulSelect;
exports.raul_simple_table = RaulSimpleTable;
exports.raul_tabs = RaulTabs;
