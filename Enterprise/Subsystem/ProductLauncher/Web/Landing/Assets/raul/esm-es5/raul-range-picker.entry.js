...
var RaulRangePicker = /** @class */ (function () {
    ...
    class_1.prototype.handleDateSelected = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        date = e.detail;
                        if (!(e.target.id === 'first')) return [3 /*break*/, 16];
                        if (!!this.startDate) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.firstPicker.closePicker()];
                    case 1:
                        _a.sent();
                        this.startDate = date;
                        this.targetDate = date;
                        this.firstPicker.setDisplay(this.formatDateForDisplay(date));
                        return [4 /*yield*/, this.secondPicker.setStateStartDate(date)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerStartDate(date)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.revertPicker()];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.openPicker()];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 16];
                    case 6: return [4 /*yield*/, this.clearFirstPicker()];
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, this.clearSecondPicker()];
                    case 8:
                        _a.sent();
                        this.startDate = date;
                        this.targetDate = date;
                        return [4 /*yield*/, this.firstPicker.setDisplay(this.formatDateForDisplay(date))];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setDisplay('')];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.closePicker()];
                    case 11:
                    ...
                    case 15:
                        ...
                        _a.label = 16;
                    case 16:
                        if (!(e.target.id === 'second')) return [3 /*break*/, 58];
                        if (!!this.endDate) return [3 /*break*/, 32];
                        if (!(date > this.startDate)) return [3 /*break*/, 18];
                        this.endDate = date;
                        this.firstPicker.setStateEndDate(date);
                        this.firstPicker.setPickerEndDate(date);
                        return [4 /*yield*/, this.secondPicker.setDisplay(this.formatDateForDisplay(date))];
                    case 17:
                        _a.sent();
                        _a.label = 18;
                    case 18:
                        if (!(date < this.startDate)) return [3 /*break*/, 31];
                        this.endDate = this.startDate;
                        this.startDate = date;
                        return [4 /*yield*/, this.secondPicker.setStateStartDate(this.startDate)];
                    case 19:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerStartDate(this.startDate)];
                    case 20:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setStateEndDate(this.endDate)];
                    case 21:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerEndDate(this.endDate)];
                    case 22:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateStartDate(this.startDate)];
                    case 23:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerStartDate(this.startDate)];
                    case 24:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateEndDate(this.endDate)];
                    case 25:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerEndDate(this.endDate)];
                    case 26:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setDisplay(this.formatDateForDisplay(this.startDate))];
                    case 27:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setDisplay(this.formatDateForDisplay(this.endDate))];
                    case 28:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.revertPicker()];
                    case 29:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.revertPicker()];
                    case 30:
                    ...
                    case 32:
                        if (!(date > this.targetDate)) return [3 /*break*/, 45];
                        this.endDate = date;
                        return [4 /*yield*/, this.secondPicker.setStateStartDate(this.targetDate)];
                    case 33:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerStartDate(this.targetDate)];
                    case 34:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setStateEndDate(this.endDate)];
                    case 35:
                    ...
                    case 38:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateStartDate(this.targetDate)];
                    case 39:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerStartDate(this.targetDate)];
                    case 40:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateEndDate(this.endDate)];
                    case 41:
                    ...
                    case 42:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setDisplay(this.formatDateForDisplay(this.targetDate))];
                    case 43:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.revertPicker()];
                    case 44:
                        ...
                        _a.label = 45;
                    case 45:
                        if (!(date < this.targetDate)) return [3 /*break*/, 58];
                    ...
                    case 47:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setStateEndDate(this.targetDate)];
                    case 48:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerEndDate(this.targetDate)];
                    case 49:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setDisplay(this.formatDateForDisplay(this.targetDate))];
                    case 50:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.revertPicker()];
                    case 51:
                    ...
                    case 53:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateEndDate(this.targetDate)];
                    case 54:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerEndDate(this.targetDate)];
                    case 55:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setDisplay(this.formatDateForDisplay(this.startDate))];
                    case 56:
    ...
    class_1.prototype.clearFirstPicker = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.firstPicker.setStateStartDate(null)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerStartDate(null)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateEndDate(null)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerEndDate(null)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setStateEndDate(null)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, this.firstPicker.setPickerDate(null)];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    class_1.prototype.clearSecondPicker = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.secondPicker.setStateStartDate(null)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerStartDate(null)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setStateEndDate(null)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerEndDate(null)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.secondPicker.setPickerDate(null)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("div", { style: { maxWidth: '550px' } }, h("raul-content", null, "Start & End range [WIP]"), h("div", { class: 'flex flex-row justify-start' }, h("div", { class: 'flex-1' }, h("raul-date-picker", { variant: 'range', ref: function (el) { return _this.firstPicker = el; }, id: 'first', isInRangePicker: true, label: 'Start date' })), h("div", { class: 'flex-1 ml-2' }, h("raul-date-picker", { variant: 'range', ref: function (el) { return _this.secondPicker = el; }, id: 'second', isInRangePicker: true, label: 'End date' })))));
    };
...
export { RaulRangePicker as raul_range_picker };
