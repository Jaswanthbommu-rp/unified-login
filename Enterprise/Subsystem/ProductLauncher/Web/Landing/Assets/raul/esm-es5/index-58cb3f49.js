import { g as getCjsExportFromNamespace } from './_commonjsHelpers-f34b4464.js';
// Fallback locale.
...
function () {
    ...
    function RelativeTimeFormat() {
        ...
        var numeric = options.numeric, style = options.style, localeMatcher = options.localeMatcher; // Set `numeric` option.
        if (numeric) {
...
function _createClass$1(Constructor, protoProps, staticProps) { if (protoProps)
    ...
    _defineProperties$1(Constructor, staticProps); return Constructor; }
...
function _typeof$2(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    _typeof$2 = function _typeof(obj) { return typeof obj; };
}
else {
    _typeof$2 = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function (key) { _defineProperty$2(target, key, source[key]); });
} return target; }
function _defineProperty$2(obj, key, value) { if (key in obj) {
    Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
}
else {
    obj[key] = value;
...
function _createClass$2(Constructor, protoProps, staticProps) { if (protoProps)
    ...
    _defineProperties$2(Constructor, staticProps); return Constructor; }
...
function () {
    ...
    _createClass$2(JavascriptTimeAgo, [{
            ...
            value: function format(input) {
                ...
                var _getDateAndTimeBeingF = getDateAndTimeBeingFormatted(input), date = _getDateAndTimeBeingF.date, time = _getDateAndTimeBeingF.time; // Get locale messages for this formatting flavour
                ...
                var unit = step.unit, factor = step.factor, granularity = step.granularity;
...
export { JavascriptTimeAgo as J, en$1 as e };
