...
var DocsCode = /** @class */ (function () {
    function DocsCode(hostRef) {
        registerInstance(this, hostRef);
        this.language = 'html';
    }
    DocsCode.prototype.componentDidLoad = function () {
        prism.plugins.NormalizeWhitespace.setDefaults();
        prism.highlightAll();
    };
    DocsCode.prototype.render = function () {
        return (h("pre", { class: "line-numbers" }, h("code", { class: "language-" + this.language }, "" + this.code)));
    };
    Object.defineProperty(DocsCode, "style", {
        get: function () { return "docs-code{display:block}"; },
        enumerable: true,
        configurable: true
    });
    return DocsCode;
}());
export { DocsCode as docs_code };
