...
var Snackbar = function (props) {
    var _a;
    var variant = props.variant, dismissable = props.dismissable, heading = props.heading, content = props.content, ctaMessage = props.ctaMessage, ctaUrl = props.ctaUrl, ctaCallback = props.ctaCallback, onCloseCallback = props.onCloseCallback;
    return (h("div", { class: 'r-snackbar__container' }, h("div", { class: (_a = {
                'r-snackbar__left-bar': true
            },
            _a["r-snackbar__left-bar--" + variant] = true,
            _a) }), h("div", { class: 'r-snackbar__content-container' }, h("div", { class: 'r-snackbar__heading' }, h("span", null, heading), dismissable &&
        h("div", { class: 'r-snackbar__heading__close-button', onClick: function () { return onCloseCallback(); }, role: "button", tabindex: 0, onKeyPress: function (e) {
                if (e.key === 'Enter') {
                    onCloseCallback();
                }
            } }, h("raul-icon", { icon: 'close' }))), content &&
        h("div", { class: 'r-snackbar__content' }, content), ctaMessage
        ? ctaUrl ?
            h("a", { href: ctaUrl }, h("div", { class: 'r-snackbar__cta' }, ctaMessage))
            :
                h("div", { class: 'r-snackbar__cta__message', role: 'button', tabindex: 0, onKeyPress: function (e) {
                        if (e.key === 'Enter') {
                            ctaCallback && ctaCallback();
                        }
                    } }, h("span", { role: 'button', onClick: ctaCallback && (function () { return ctaCallback(); }) }, ctaMessage))
        : null)));
};
...
var RaulSnackbar = /** @class */ (function () {
    function RaulSnackbar(hostRef) {
    ...
    RaulSnackbar.prototype.componentWillLoad = function () {
        var _this = this;
    ...
    RaulSnackbar.prototype.disconnectedCallback = function () {
        clearTimeout(this.timeoutTimer);
        clearInterval(this.refreshTimer);
    };
    RaulSnackbar.prototype.handleMouseenter = function () {
        if (this.timeout) {
    ...
    RaulSnackbar.prototype.handleMouseleave = function () {
        var _this = this;
        if (this.timeout) {
            this.timeoutTimer = window.setTimeout(function () {
                // this.timedOut.emit()
    ...
    RaulSnackbar.prototype.dismiss = function () {
        var _this = this;
        this.el.classList.add('r-snackbar--fadeout');
        setTimeout(function () { return _this.el.remove(); }, 1000);
    };
    RaulSnackbar.prototype.createdAtTimeAgo = function () {
