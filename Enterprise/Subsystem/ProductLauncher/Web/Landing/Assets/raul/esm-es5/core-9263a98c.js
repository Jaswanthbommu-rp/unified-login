...
var BUILD = { "allRenderFn": false, "cmpDidLoad": true, "cmpShouldUpdate": false, "cmpDidUnload": true, "cmpDidUpdate": true, "cmpDidRender": true, "cmpWillLoad": true, "cmpWillUpdate": false, "cmpWillRender": false, "connectedCallback": true, "disconnectedCallback": true, "element": false, "event": true, "hasRenderFn": true, "lifecycle": true, "asyncLoading": true, "hostListener": true, "hostListenerTargetWindow": true, "hostListenerTargetDocument": false, "hostListenerTargetBody": false, "hostListenerTargetParent": false, "hostListenerTarget": true, "member": true, "method": true, "mode": false, "noVdomRender": false, "observeAttribute": true, "prop": true, "propBoolean": true, "propNumber": true, "propString": true, "propMutable": true, "reflect": true, "scoped": false, "shadowDom": false, "shadowDelegatesFocus": false, "slot": true, "slotRelocation": true, "state": true, "style": true, "svg": true, "updatable": true, "vdomAttribute": true, "vdomXlink": true, "vdomClass": true, "vdomFunctional": true, "vdomKey": true, "vdomListener": true, "vdomRef": true, "vdomRender": true, "vdomStyle": true, "vdomText": true, "watchCallback": true, "taskQueue": true, "cloneNodeFix": false, "appendChildSlotFix": false, "lazyLoad": true, "hydrateServerSide": false, "cssVarShim": true, "initializeNextTick": true, "hydrateClientSide": false, "isDebug": false, "isDev": false, "devTools": false, "lifecycleDOMEvents": false, "profile": false, "hotModuleReplacement": false, "constructableCSS": true, "cssAnnotations": true };
var NAMESPACE = 'raul';
...
function toast(options) {
    if (options === void 0) { options = {}; }
    //@ts-ignore
    var toaster = maybeCreateToaster(options.tagName);
    var toast = makeToast(toaster, options);
    return toast;
}
function maybeCreateToaster(tagName) {
    if (tagName === 'raul-toast') {
        if (!document.querySelector('raul-toaster')) {
            var toaster = document.createElement('raul-toaster');
    ...
    if (tagName === 'raul-snackbar') {
        if (!document.querySelector('raul-snackbar-group')) {
            var snackbarGroup = document.createElement('raul-snackbar-group');
...
function makeToast(toaster, options) {
    var toast = document.createElement(options.tagName);
    var timeout = options.timeout, avatar = options.avatar, origin = options.origin, variant = options.variant, dismissable = options.dismissable, heading = options.heading, body = options.body, content = options.content, ctaMessage = options.ctaMessage, ctaUrl = options.ctaUrl, ctaCallback = options.ctaCallback, meta = options.meta, actions = options.actions, read = options.read, severity = options.severity;
...
function defineCommands(context) {
    context.RAUL.commands = {
        toast: toast
    };
}
function defineMisc(context) {
    context.RAUL.misc = {
        productIcons: [
            {
                "icon": "asset-and-investment-management",
            ...
            {
                "icon": "ilm-leasing-analytics",
                "name": "ILM Leasing Analytics"
            },
            {
                "icon": "intelligent-lead-management",
                "name": "ILM"
            },
            {
                "icon": "investment-analytics",
            ...
            {
                "icon": "onesite-screening",
                "name": "OneSite Screening"
            },
            {
                "icon": "onesite",
                "name": "OneSite"
            ...
            {
                "icon": "portfolio-asset-management",
                "name": "Portfolio Asset Management"
            },
            {
                "icon": "property-photos",
            ...
            {
                "icon": "prospect-contact-center",
                "name": "Prospect Contact Center"
            },
            {
                "icon": "realpage-accounting",
                "name": "RealPage Accounting"
            },
            {
                "icon": "realpage-document-management",
                "name": "RealPage Document Management"
            },
            {
                "icon": "realpage-portfolio-management",
                "name": "RealPage Portfolio Management"
            },
            {
                "icon": "relate-24-7",
                "name": "Relate 24/7"
            ...
            {
                "icon": "resident-portals",
                "name": "Resident Portals"
            },
            {
                "icon": "resident-services",
                "name": "Resident Services"
            },
            {
                "icon": "revenue-forecaster",
            ...
            {
                "icon": "windsor-consulting",
                "name": "Windsor Consulting"
            },
            {
                "icon": "yieldstar",
                "name": "Yieldstar"
...
var win$1 = window;
win$1.RAUL = win$1.RAUL || {};
win$1.RAUL.version = '0.5.0';
defineCommands(win$1);
defineMisc(win$1);
export { Host as H, patchEsm as a, bootstrapLazy as b, createEvent as c, getContext as d, getElement as g, h, patchBrowser as p, registerInstance as r, toast as t };
