...
var RaulRadio = /** @class */ (function () {
    function RaulRadio(hostRef) {
    ...
    RaulRadio.prototype.render = function () {
        return (h("div", { class: {
                'r-radio': true,
