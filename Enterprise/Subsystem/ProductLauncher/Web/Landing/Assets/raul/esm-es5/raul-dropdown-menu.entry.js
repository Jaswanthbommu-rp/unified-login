...
var RaulDropdownMenu = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.handleMenuItemClick = function (payload) {
            _this.optionSelected.emit(payload);
        };
        this.handleMenuItemBlur = function (e) {
            requestAnimationFrame(function () {
                var length = _this.dropdown.querySelectorAll('.r-dropdown-menu__menu-item').length;
                if ((e.target === _this.dropdown.querySelectorAll('.r-dropdown-menu__menu-item')[length - 1])
                    &&
                        (document.activeElement !== _this.dropdown.querySelectorAll('.r-dropdown-menu__menu-item')[length - 2])) {
                    _this.open = false;
                }
            });
        };
    ...
    class_1.prototype.componentDidLoad = function () {
        ...
        window.addEventListener('click', function (e) {
            // @ts-ignore
            if (_this.open && !_this.dropdown.contains(e.target) && !_this.toggle.contains(e.target)) {
                _this.open = false;
            }
        }, true); // third argument is capture
    };
    class_1.prototype.handleOpenChange = function (newValue, oldValue) {
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: {
            ...
            }, onKeyDown: this.handleEscape }, h("div", { onClick: this.handleToggleClick, class: 'r-dropdown-menu__toggle', role: "button", tabIndex: 0, onKeyDown: this.handleKeyDown, ref: function (el) { return _this.toggle = el; } }, h("div", { class: 'r-dropdown-menu__toggle__focus-utility', tabindex: -1 }, h("slot", { name: "toggle" }))), h("div", { ref: function (el) { return _this.dropdown = el; }, class: {
            ...
            } }, this.items && this.items.map(function (item) { return h(MenuItem, Object.assign({}, item, { onBlurCallback: _this.handleMenuItemBlur, onClickCallback: _this.handleMenuItemClick, disabled: _this.disabled })); }), h("slot", null))));
    };
