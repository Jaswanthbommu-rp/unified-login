...
var DocsRaulStatusIndicator = /** @class */ (function () {
    function DocsRaulStatusIndicator(hostRef) {
        registerInstance(this, hostRef);
    }
    DocsRaulStatusIndicator.prototype.componentDidLoad = function () {
        initPage('Status Indicator');
    };
    DocsRaulStatusIndicator.prototype.render = function () {
    ...
    return DocsRaulStatusIndicator;
}());
