...
var RaulSimpleSelect = /** @class */ (function () {
    function RaulSimpleSelect(hostRef) {
        registerInstance(this, hostRef);
        this.inputId = "raul-select-" + selectIds++;
    }
    RaulSimpleSelect.prototype.render = function () {
        return (h("div", { class: {
                'r-form-element': true,
