...
const RaulModal = class {
    ...
    render() {
        return (h("div", { class: {
            ...
            }, tabindex: "-1", ref: el => this.overlay = el }, h("div", { ref: el => this.modal = el, class: {
...
const RaulModal$1 = class {
    ...
    render() {
        return (h("div", { class: 'r-modal__header__container' }, h("div", { class: 'r-modal__header__items' }, h("raul-content", null, h("h2", { class: 'font-xl' }, this.modalTitle), h("p", null, this.description))), h("div", { class: 'r-modal__header__close-button', role: 'button', tabindex: "0", onClick: () => this.modalClose.emit(), onKeyDown: e => {
                if (e.key === 'Enter')
                    this.modalClose.emit();
