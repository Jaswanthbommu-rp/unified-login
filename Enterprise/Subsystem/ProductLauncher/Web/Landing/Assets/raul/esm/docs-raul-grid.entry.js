...
const DocsRaulGrid = class {
  ...
  `;
    ...
    render() {
        return (h("docs-element", { title: "Grid" }, h("div", { slot: "overview" }, h("docs-showcase", null, h("div", { class: "mt-10" }, h("div", { class: "heading-lg" }, "Basic"), h("div", { innerHTML: this.basicGridTemplate }), h("docs-code", { class: "mt-5", code: this.basicGridTemplate })), h("div", { class: "mt-10" }, h("div", { class: "heading-lg" }, "Striped and Hoverable"), h("div", { innerHTML: this.stripedAndHoverableeGridTemplate }), h("docs-code", { class: "mt-5", code: this.stripedAndHoverableeGridTemplate })))), h("div", { slot: "design" }), h("div", { slot: "api" }, h("docs-interface", { component: "raul-grid" }))));
    }
};

export { DocsRaulGrid as docs_raul_grid };
