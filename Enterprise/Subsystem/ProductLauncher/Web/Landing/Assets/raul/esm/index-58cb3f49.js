...
const require$$0 = getCjsExportFromNamespace(long$1);

const require$$1 = getCjsExportFromNamespace(short$1);

const require$$2 = getCjsExportFromNamespace(narrow$1);
...
const require$$0$1 = getCjsExportFromNamespace(shortTime$1);

const require$$1$1 = getCjsExportFromNamespace(shortConvenient$1);

const require$$2$1 = getCjsExportFromNamespace(longTime$1);

const require$$3 = getCjsExportFromNamespace(longConvenient$1);

const require$$4 = getCjsExportFromNamespace(tiny$1);
