    ...
    render() {
        return (h(Host, null, this.label &&
            h("div", { class: "r-progress__label" }, this.label, !this.static &&
                h("button", { type: "button", class: "r-progress__remove-btn", onClick: () => this.handleProgressRemove() }, h("raul-icon", { icon: "remove-2" }))), h("div", { class: "r-progress__bar" }, h("div", { class: "r-progress__bar__value", style: { width: `${this.value}%` } })), h("div", { class: "r-progress__text" }, `${this.value}%`, " ", !this.static && this.hint)));
    }
