...
const DocsRaulTooltip = class {
  ...
  `;
    ...
    render() {
        return (h("docs-element", { title: "Tooltips" }, h("div", { slot: "overview" }, h("docs-showcase", null, h("div", null, h("div", { class: "heading-lg" }, "Basic"), h("div", { innerHTML: this.basicTooltip }), h("docs-code", { class: "mt-5", code: this.basicTooltip })), h("div", { class: "mt-10" }, h("div", { class: "heading-lg" }, "Positioned"), h("div", { class: "flex justify-center" }, h("div", { class: "md:w-6/12", innerHTML: this.positionedTooltips })), h("docs-code", { class: "mt-5", code: this.positionedTooltips })), h("div", { class: "mt-10" }, h("div", { class: "heading-lg" }, "Disabled Hover Listener"), h("div", { innerHTML: this.disabledHoverTooltip }), h("docs-code", { class: "mt-5", code: this.disabledHoverTooltip })), h("div", { class: "mt-10" }, h("div", { class: "heading-lg" }, "Disabled Focus Listener"), h("div", { innerHTML: this.disabledFocusTooltip }), h("docs-code", { class: "mt-5", code: this.disabledFocusTooltip })))), h("div", { slot: "design" }, "Design Guidelines"), h("div", { slot: "api" }, h("docs-interface", { component: "raul-tooltip" }))));
    }
};

export { DocsRaulTooltip as docs_raul_tooltip };
