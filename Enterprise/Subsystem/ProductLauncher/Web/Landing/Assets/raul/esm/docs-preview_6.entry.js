...
const DocsPreview = class {
    ...
    render() {
        ...
        return (h("div", { class: "r-docs-preview page-section" }, h("h2", { id: "preview", class: "text-lg font-bold" }, "Preview"), h("div", { class: "r-docs-preview__widget" }, h("div", { class: "r-docs-preview__component", style: { padding: '16px !important' } }, h(ComponentTag, { ref: (el) => this.componentEl = el, innerHTML: this.content })), h("div", { class: "r-docs-preview__controls" }, h("docs-preview-props", { component: this.component })), h("div", { class: "r-docs-preview__snippet" }, h("pre", null, h("code", null, this.componentHTML))))));
    }
...
const DocsPreviewProps = class {
    ...
    renderPropControl(doc) {
        ...
        if (type === 'string') {
            return (h("raul-input", { label: labelText }, h("input", { class: "mb-4", type: "text", value: fallback, onInput: e => emitChange(e.target.value) })));
        }
        if (type === 'boolean') {
            return (h("raul-switch", { "label-text": labelText }, h("input", { type: 'checkbox', checked: false, onChange: e => emitChange(e.target.checked) })));
        }
