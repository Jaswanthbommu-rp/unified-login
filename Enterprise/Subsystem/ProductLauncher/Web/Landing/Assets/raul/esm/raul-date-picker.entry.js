  ...
  */
    ...
    render() {
        const PickerToggle = () => (h("div", { class: {
            ...
            }) }, h("div", { class: 'r-date-picker__toggle__value' }, this.display), h("div", { class: 'r-date-picker__toggle__icon' }, h("raul-icon", { icon: 'calendar-2' }))));
        const PickerHeader = () => (h("div", null, h("div", { class: 'r-date-picker__header' }, h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousMonth }), h("div", { role: 'button', class: 'r-date-picker__header__month-year-label', onClick: this.handleMonthYearClick, tabindex: 0, onKeyDown: this.handleHeaderKeyDown }, h("div", { class: 'r-date-picker__header__month-year-label__focus-utility', tabindex: -1 }, `${this.months[this.activeMonth]} ${this.activeYear}`)), h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextMonth }))));
        ...
        const MonthPicker = () => (h("div", { class: 'r-date-picker__months-view' }, h("div", { class: 'r-date-picker__months-view__header' }, h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousYear }), h("div", { class: 'r-date-picker__months-view__year-label', onClick: this.handleMonthYearClick, tabindex: 0, onKeyDown: this.handleYearFocusedKeyDown }, h("div", { class: 'r-date-picker__months-view__year-label__focus-utility' }, this.activeYear)), h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextYear })), h("div", { class: 'r-date-picker__months-view__months-container', tabindex: 0, onKeyDown: this.handleKeyDown }, this.months.map((month, index) => (h("div", { class: {
        ...
        const YearPicker = () => (h("div", { class: 'r-date-picker__years-view' }, h("div", { class: 'r-date-picker__years-view__header' }, h("raul-icon", { icon: 'arrow-left-v', onClick: this.handlePreviousYearsRange }), h("div", { class: 'r-date-picker__months-view__year-label' }, h("div", { class: 'r-date-picker__months-view__year-label__focus-utility', tabindex: -1 }, `${this.yearsRangeStart} - ${this.yearsRangeStart + 11}`)), h("raul-icon", { icon: 'arrow-right-v', onClick: this.handleNextYearsRange })), h("div", { class: 'r-date-picker__years-view__years-container', tabindex: 0, onKeyDown: this.handleKeyDown }, Array.from({ length: 12 }).map((_, index) => h("div", { class: {
        ...
        return (h("div", { ref: el => this.el = el, onKeyDown: e => {
            ...
            } }, this.label && h("label", { class: "r-date-picker__label" }, this.label), h("div", { class: 'r-date-picker' }, h(PickerToggle, null), h("div", { class: 'r-date-picker__container__responsive-utility-wrapper' }, h("div", { ref: el => this.dropdown = el, class: {
