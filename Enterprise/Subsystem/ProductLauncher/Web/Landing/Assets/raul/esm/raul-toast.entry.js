...
const RaulToast = class {
    ...
    render() {
        return (h("div", { class: {
            ...
            }, ref: el => this.toastEl = el }, h("div", { class: {
                'r-toast__header': true,
                'r-toast__header--read': this.read,
            } }, h("div", { class: "r-toast__origin" }, this.origin), h("div", { class: "r-toast__timestamp" }, this.createdAtTimeAgo()), h("button", { type: "button", class: "r-toast__dismiss", onClick: (e) => this.emitToastAction(e, 'dismiss') }, h("raul-icon", { icon: "arrow-right-1" }))), h("div", { class: "r-toast__body" }, this.avatar &&
            ...
            h("div", { class: "r-toast__priority" }, this.severity))), h("div", { class: "r-toast__footer" }, this.actions && this.actions.map((action) => h("button", { type: "button", class: "r-toast__action", onClick: (e) => this.emitToastAction(e, action.label) }, action.text)))));
    }
