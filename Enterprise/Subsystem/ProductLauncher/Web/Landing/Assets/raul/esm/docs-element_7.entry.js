...
const DocsElement = class {
    ...
    render() {
        return (h("div", { class: "docs-element" }, h("div", { class: "docs-page-header tabbed" }, h("h1", null, this.title), h("raul-tabs", { tabs: [
                ...
                { label: "API", name: "api" },
            ], "active-tab": this.activeTab, onRaulTabChange: (e) => this.activeTab = e.detail })), h("div", { class: "p-4 md:p-12" }, h("div", { style: { display: this.activeTab === 'overview' ? 'block' : 'none' } }, h("slot", { name: "overview" })), h("div", { style: { display: this.activeTab === 'design' ? 'block' : 'none' } }, h("slot", { name: "design" })), h("div", { style: { display: this.activeTab === 'api' ? 'block' : 'none' } }, h("slot", { name: "api" })))));
    }
};
...
const DocsInterface = class {
    ...
    render() {
        ...
        return (h("div", { class: "r-docs-interface page-section" }, h("h2", { class: "text-lg font-bold mb-6" }, "Component API"), h("div", { class: "r-docs-interface__section page-section" }, h("h4", { id: "props", class: "text-sm uppercase font-bold" }, "Props"), this.docs.props.length > 0 &&
            h("raul-simple-table", null, h("table", null, h("thead", null, h("tr", null, h("th", null, "Name"), h("th", null, "Type"), h("th", null, "Default"), h("th", null, "Description"))), h("tbody", null, this.docs.props.map(prop => {
            ...
            h("raul-simple-table", null, h("table", null, h("thead", null, h("tr", null, h("th", null, "Method"), h("th", null, "Description"))), h("tbody", null, this.docs.methods.map(method => {
            ...
            h("raul-simple-table", null, h("table", null, h("thead", null, h("tr", null, h("th", null, "Name"), h("th", null, "Description"))), h("tbody", null, this.docs.events.map(event => {
...
const RaulOption = class {
    ...
    render() {
        return (h(Host, { class: {
            ...
            ? h("raul-checkbox", { small: true }, h("input", { type: "checkbox", tabindex: "-1", "aria-hidden": "true", checked: this.selected, disabled: this.disabled, value: this.value, ref: el => el && (el.indeterminate = this.indeterminate) }))
    ...
    render() {
        ...
        const renderSelectToggleContent = () => {
            if (!this.hasSlot('select-toggle')) {
                return (h("div", { class: {
                    ...
                    } }, h("div", { class: "r-select__toggle__content__text" }, this.selectedOptionsText() || this.placeholder), h("raul-icon", { icon: "arrow-down-v", class: "r-select__toggle__content__arrow" })));
            }
        };
        ...
        const renderSelectMenuMobileLabelContent = () => {
            if (!this.hasSlot('select-mobile-label')) {
                return (h("div", { class: "r-select__mobile-label__content" }, h("div", { class: "r-select__mobile-label__content__button" }, h("span", { onClick: () => this.close() }, "Cancel")), this.label &&
                    h("div", { class: "r-select__mobile-label__content__text" }, this.label), this.multiple &&
                    h("div", { class: {
        ...
        const renderSelectMenuSearch = () => {
            if (this.searchable) {
                return (h("div", { class: "r-select__search" }, h("raul-icon", { icon: "search", class: "r-select__search__icon" }), h("input", { type: "text", class: "r-select__search__input", placeholder: "Search", value: this.searchQuery, onInput: e => this.handleSearch(e), ref: el => this.searchInputEl = el }), this.searchQuery &&
        ...
        const renderOptionsGroup = (group) => {
            ...
            const enabledOptionsSelected = this.multiple
                ...
                : false;
            return (h("div", { class: "r-options-group", role: "group" }, h("raul-option", { variant: "group", multiple: this.multiple, selected: selected, focused: focused, disabled: disabled, value: value, text: text, description: description, indeterminate: indeterminate, optionId: id, onClick: this.multiple
        ...
        return [
            ...
            h("div", { class: {
                ...
                }, ref: el => this.selectEl = el }, h("button", { type: "button", class: "r-select__toggle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.opened ? 'true' : 'false', "aria-activedescendant": this.focusedOptionId, onClick: () => this.toggle(), ref: el => this.toggleButtonEl = el }, renderSelectToggleContent(), h("slot", { name: "select-toggle" })), this.hint && h("small", { class: "r-select__hint" }, this.hint), this.error &&
                h("div", { class: "r-select__error" }, h("raul-icon", { icon: "interface-alert-diamond", class: "r-select__error__icon" }), " ", this.error), h("div", { class: "r-select__menu", ref: el => this.selectMenuEl = el }, h("div", { class: "r-select__menu__content" }, renderSelectMenuHeader(), h("div", { class: "r-select__menu__body", role: "listbox", tabindex: "-1", "aria-multiselectable": this.multiple ? 'true' : null, style: { maxHeight: this.optionsMaxHeight } }, this.visibleOptionsAndGroups().map(option => {
...
const RaulTabs = class {
    ...
    render() {
        if (!(this.selectOnMobile && this.xsDevice)) {
            return (h("div", { class: "tabs", role: "tablist" }, h("div", { class: "tabs__list" }, this.tabs.map(item => {
