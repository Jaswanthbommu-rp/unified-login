...
const ButtonComponent = class {
    ...
    render() {
        ...
        return (h("div", { class: {
            ...
            } }, h("div", { class: "r-button__focus-ring", ref: el => this.focusRingEl = el }), renderButton(), h("div", { class: {
                'r-button__content': true,
                'r-button__content--icon-only': this.iconOnly
            } }, renderAddOrDeleteIcon(), renderIcon(), h("span", { ref: el => this.btnTextEl = el }, h("slot", null)))));
    }
