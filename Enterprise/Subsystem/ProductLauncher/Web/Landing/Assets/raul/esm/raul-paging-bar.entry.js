...
const RaulPagingBar = class {
    ...
    render() {
        return (h("div", { class: "r-paging-bar" }, h("div", { class: "r-paging-bar__col r-paging-bar__col--entries" }, "Show", h("div", { class: "r-paging-bar__entry-select" }, h("select", { onChange: (event) => this.entitesChanged(event) }, this.entities && this.entities.map(entity => (h("option", { value: entity, selected: this.rowsPerPage === entity }, entity)))), h("raul-icon", { class: "r-select__arrow", icon: "arrow-down-v" })), "entries"), h("div", { class: "r-paging-bar__col r-paging-bar__col--count" }, this.startRow, " - ", this.endRow, " of ", this.totalRows), h("div", { class: "r-paging-bar__col r-paging-bar__col--nav" }, h("button", { type: "button", "aria-label": "Previous Entries", onClick: () => this.decrement(), disabled: this.currentPage === 1 }, h("raul-icon", { icon: "arrow-left-v" })), h("div", { class: "r-paging-bar__nav" }, "Page", h("div", { class: "r-paging-bar__input" }, h("input", { type: "number", min: "1", max: this.totalPages, value: this.currentPage, onChange: (event) => this.pageValueChange(event) })), "of ", this.totalPages), h("button", { type: "button", "aria-label": "Next Entries", onClick: () => this.increment(), disabled: this.currentPage === this.totalPages }, h("raul-icon", { icon: "arrow-right-v" })))));
    }
