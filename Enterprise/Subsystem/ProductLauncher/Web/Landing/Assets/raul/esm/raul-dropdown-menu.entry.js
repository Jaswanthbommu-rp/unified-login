...
const RaulDropdownMenu = class {
    ...
    render() {
        return (h("div", { class: {
            ...
            }, onKeyDown: this.handleEscape }, h("div", { onClick: this.handleToggleClick, class: 'r-dropdown-menu__toggle', role: "button", tabIndex: 0, onKeyDown: this.handleKeyDown, ref: el => this.toggle = el }, h("div", { class: 'r-dropdown-menu__toggle__focus-utility', tabindex: -1 }, h("slot", { name: "toggle" }))), h("div", { ref: el => this.dropdown = el, class: {
            ...
            } }, this.items && this.items.map(item => h(MenuItem, Object.assign({}, item, { onBlurCallback: this.handleMenuItemBlur, onClickCallback: this.handleMenuItemClick, disabled: this.disabled }))), h("slot", null))));
    }
