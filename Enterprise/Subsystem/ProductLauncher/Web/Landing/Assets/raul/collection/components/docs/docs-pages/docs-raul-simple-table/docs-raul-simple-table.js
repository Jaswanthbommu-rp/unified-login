...
export class DocsRaulSimpleTable {
    constructor() {
  ...
  `;
    ...
    render() {
        return (h("docs-element", { title: "Simple Table" },
            h("div", { slot: "overview" },
                h("docs-showcase", null,
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "Basic"),
                        h("div", { innerHTML: this.basicTableTemplate }),
                        h("docs-code", { class: "mt-5", code: this.basicTableTemplate })),
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "Striped and Hoverable"),
                        h("div", { innerHTML: this.stripedAndHoverableTableTemplate }),
                        h("docs-code", { class: "mt-5", code: this.stripedAndHoverableTableTemplate })))),
            h("div", { slot: "design" }),
            h("div", { slot: "api" },
                h("docs-interface", { component: "raul-table" }))));
    }
    static get is() { return "docs-raul-simple-table"; }
}
