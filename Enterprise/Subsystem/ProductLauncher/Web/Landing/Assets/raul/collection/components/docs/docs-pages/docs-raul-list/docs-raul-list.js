...
export class DocsRaulList {
  ...
  `;
    ...
    render() {
        return (h("docs-element", { title: "List " },
            h("div", { slot: "overview" },
                h("docs-showcase", null,
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "Basic"),
                        h("div", { class: "md:w-6/12" },
                            h("div", { innerHTML: this.listBasic })),
                        h("docs-code", { class: "mt-5", code: this.listBasic })),
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "With title"),
                        h("div", { class: "md:w-6/12" },
                            h("div", { innerHTML: this.listWithTitle })),
                        h("docs-code", { class: "mt-5", code: this.listWithTitle })),
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "With title and subtitle"),
                        h("div", { class: "md:w-6/12" },
                            h("div", { innerHTML: this.listWithTitleAndSubtitle })),
                        h("docs-code", { class: "mt-5", code: this.listWithTitleAndSubtitle })),
                    h("div", { class: "mt-10" },
                        h("div", { class: "heading-lg" }, "With call to action"),
                        h("div", { class: "md:w-6/12" },
                            h("div", { innerHTML: this.listWithCallToAction })),
                        h("docs-code", { class: "mt-5", code: this.listWithCallToAction })))),
            h("div", { slot: "design" },
                h("docs-readme", { component: "raul-list" })),
            h("div", { slot: "api" },
                h("docs-interface", { component: "raul-list" }))));
    }
    static get is() { return "docs-raul-list"; }
}
