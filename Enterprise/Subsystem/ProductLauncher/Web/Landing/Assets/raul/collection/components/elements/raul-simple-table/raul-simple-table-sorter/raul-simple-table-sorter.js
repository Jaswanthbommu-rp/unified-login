...
export class RaulSimpleTableSorter {
    constructor() {
        this.direction = null;
    }
    handleSort() {
    ...
    render() {
        return (h("button", { type: "button", class: "r-simple-table__sorter", onClick: () => this.handleSort() },
            h("span", { class: {
    ...
    static get is() { return "raul-simple-table-sorter"; }
    static get originalStyleUrls() { return {
        "$": ["raul-simple-table-sorter.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["raul-simple-table-sorter.css"]
    }; }
