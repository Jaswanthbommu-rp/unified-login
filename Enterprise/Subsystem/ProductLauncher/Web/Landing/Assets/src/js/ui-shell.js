...
var doWindowSize = function(){
    ...
    }else if(win >= 1001){ //This width is set below the above size to make sure the cookie reads correctly
        if(!userAction){
            if($.sessionStorage.get("overlay") !== true) {
                growLeftNav();
                $(".leftNavWrapper").removeClass("mCollapsed");
...
var autoloadNonMobileFlyout = function(){
    if($.sessionStorage.get("overlay") !== true) {
...
var shrinkLeftNavMobile = function(){
...
var growLeftNavMobile = function(){
...
var leftNavFormatting = function() {
