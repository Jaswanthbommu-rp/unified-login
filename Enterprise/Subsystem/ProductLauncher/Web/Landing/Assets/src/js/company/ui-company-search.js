...
var addCompanies = function(response){

    var dataTableCompanyList = $('#company-list-view-datatable table').dataTable();

    $.each(response, function (i, company) {

        dataTableCompanyList.fnAddData([
            "<div class=\"valign-middle blue-link ft-s-12 \">\n" +
    ...
    $.each(response, function (i, company) {
        ...
        dataTableCompanyGrid.fnAddData([
    ...
    $.each(response, function (i, company) {
        ...
        dataTableCompanyMap.fnAddData([
            "<div data-location-id=\"" + company.id + "\" class=\"float-left\">\n" +
            "     <span class=\"company-photo\">\n" +
            "           <img src=\"" + company.picture + "\" /> \n" +
            "           <i class=\"on b-white bottom\"></i>\n" +
            "     </span>\n" +
