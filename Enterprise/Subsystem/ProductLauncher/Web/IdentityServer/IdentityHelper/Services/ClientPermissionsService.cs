...
{
    public class ClientPermissionsService : IClientPermissionsService
    {
        ...
        public ClientPermissionsService(IPermissionsStore permissionsStore, IClientStore clientStore,
            IScopeStore scopeStore, ILocalizationService localizationService)
        {
        ...
        public virtual async Task<IEnumerable<ClientPermission>> GetClientPermissionsAsync(string subject)
        {
            ...
            var consents = await this._permissionsStore.LoadAllAsync(subject);
        ...
        public virtual async Task RevokeClientPermissionsAsync(string subject, string clientId)
        {
            ...
            await this._permissionsStore.RevokeAsync(subject, clientId);
        }
    }
}