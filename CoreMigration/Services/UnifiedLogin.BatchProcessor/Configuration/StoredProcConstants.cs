...
public static class StoredProcNameConstants
{
    ...
    internal const string SP_ListFutureLogins = "Ident.ListFutureLogins";
    internal const string SP_ListPendingUsers = "Ident.ListPendingUsers";
    internal const string SP_ListExpiringUsers = "Ident.ListExpiringUsers";
}
