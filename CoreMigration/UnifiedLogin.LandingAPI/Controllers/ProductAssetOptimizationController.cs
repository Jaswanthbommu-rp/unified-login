...
namespace UnifiedLogin.LandingAPI.Controllers
{
    ...
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/products/ao")]
    public class ProductAssetOptimizationController : ControllerBase
    {
        ...
        public ProductAssetOptimizationController(IUserClaimsAccessor userClaimsAccessor, IManagePersona managePersona)
        {
