...
namespace UnifiedLogin.BusinessLogic.Logic.Product.Interfaces
{
    ...
    public interface IManageProductOneSiteAccounting
    {
        ...
        string UpdateRolesToUser(long editorPersonaId, long userPersonaId, List<string> rolesToAssign, bool isAccountingAdmin, out List<AdditionalParameters> additionalParametersRoles, BatchProcessType batchProcessType = BatchProcessType.CreateUpdateProductUser, ListResponse currentRolesList = null); 
