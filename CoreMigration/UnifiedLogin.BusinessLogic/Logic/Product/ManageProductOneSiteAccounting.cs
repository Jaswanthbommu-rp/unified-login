...
namespace UnifiedLogin.BusinessLogic.Logic.Product
{
    ...
    public class ManageProductOneSiteAccounting : ManageProductBase, IManageProductOneSiteAccounting
    {
        ...
        public ListResponse UpdateRolesForRight(long editorPersonaId, int rightId, List<ProductRoleAcct> rolesToAdd, List<ProductRoleAcct> rolesToRemove, ProductRightAcct right)
        {
            ...
            UnifiedLogin.SharedObjects.Product.OneSiteAccounting.User[] user = new UnifiedLogin.SharedObjects.Product.OneSiteAccounting.User[1] { new UnifiedLogin.SharedObjects.Product.OneSiteAccounting.User() };
    ...
    public static class ManageProductOneSiteAccountingHelpers
    {
        ...
        /// <returns></returns>
        public static IList<UnifiedLogin.SharedObjects.Product.ProductUser> ToGBUsers(this UnifiedLogin.SharedObjects.Product.OneSiteAccounting.User[] users)
        {
            if (users == null) return null;
            IList<UnifiedLogin.SharedObjects.Product.ProductUser> results = new List<UnifiedLogin.SharedObjects.Product.ProductUser>();
            return results;
        }
