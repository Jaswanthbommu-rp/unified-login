...
namespace UnifiedLogin.BusinessLogic.Logic.Product
{
    ...
    public static class OneSiteHelpers
    {
        ...
        /// <returns></returns>
        public static IList<UnifiedLogin.SharedObjects.Product.ProductUser> ToGBUsers(this UserList users)
        {
            ...
            {
                results.Add(new UnifiedLogin.SharedObjects.Product.ProductUser
                {
                    UserId = user.UserId,
