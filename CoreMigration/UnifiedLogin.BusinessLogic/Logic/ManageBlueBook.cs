...
namespace UnifiedLogin.BusinessLogic.Logic
{
    ...
    public class ManageBlueBook : IDisposable, IManageBlueBook
    {
        ...
        /// <returns></returns>
        public IList<UnifiedLogin.SharedObjects.BlackBook.Company> GetCompanyListByCompIds(List<UnifiedLoginCompany> booksCompanyMasterList)
        {
            IList<UnifiedLogin.SharedObjects.BlackBook.Company> companyInstance = new List<UnifiedLogin.SharedObjects.BlackBook.Company>();

            // get the hash of the full company list
            int booksCompanyMasterHash = GetCompanyIds(booksCompanyMasterList).GetHashCode();

            companyInstance = _manageBlueBookCache[$"getCompanysByCompIds_{booksCompanyMasterHash}"] as List<UnifiedLogin.SharedObjects.BlackBook.Company>;
            if (companyInstance == null)
            {
                ...
                ConcurrentBag<UnifiedLogin.SharedObjects.BlackBook.Company> result = new ConcurrentBag<UnifiedLogin.SharedObjects.BlackBook.Company>();
