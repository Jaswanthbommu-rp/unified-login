...
/// <summary>
/// Async handler for <c>BatchProcessType.CreateUpdateProductUser</c> and
/// <c>BatchProcessType.PrimaryPropertiesUpdateProductUser</c>.
/// <para>
/// Replaces the sync <c>CreateUpdateProductUser</c> which directly instantiated
/// <c>new ManageProductUser(new DefaultUserClaim { CorrelationId = Guid.NewGuid() })</c>.
/// All repository and integration dependencies are resolved through DI via
/// <see cref="IManageProductUserAsync"/>.
/// </para>
/// </summary>
public sealed class CreateUpdateProductUserAsync : IProcessExecutionAsync
{
    private readonly IManageProductUserAsync _manageProductUser;

    public CreateUpdateProductUserAsync(IManageProductUserAsync manageProductUser)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await _manageProductUser.CreateProductUserAsync(batchRecord, cancellationToken)
