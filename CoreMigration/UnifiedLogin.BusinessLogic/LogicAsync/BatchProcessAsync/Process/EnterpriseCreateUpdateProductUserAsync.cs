...
/// <summary>
/// Async handler for <c>BatchProcessType.EnterpriseRoleCreateUpdateProductUser</c>.
/// <para>
/// Replaces the sync <c>EnterpriseCreateUpdateProductUser</c> which directly instantiated
...
/// </para>
/// </summary>
public sealed class EnterpriseCreateUpdateProductUserAsync : IProcessExecutionAsync
{
    private readonly IManageProductUserAsync _manageProductUser;

    public EnterpriseCreateUpdateProductUserAsync(IManageProductUserAsync manageProductUser)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await _manageProductUser
            .CreateEnterpriseRoleProductUserAsync(batchRecord, cancellationToken)
