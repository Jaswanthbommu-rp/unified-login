...
namespace UnifiedLogin.LandingAPI.Test.ControllerTest.Product
{
    ...
    public class ProductOnSiteTest
    {
        private readonly RouteTestBase _baseTest;
        private const string _baseUrl = "http://localhost/api/products/onsite";

        #region Constructor
        public ProductOnSiteTest()
        {
        ...
        [Fact]
        public void ListOnSiteMigrationUsers_VerifyRouteToAction_ReturnAction()
        {
            //Arrange
            var expected = "ListOnSiteMigrationUsers";
        ...
        [Fact]
        public void DisableOnSiteUser_VerifyRouteToAction_ReturnAction()
        {
            //Arrange
            var expected = "UpdateOnSiteUserStatus";
