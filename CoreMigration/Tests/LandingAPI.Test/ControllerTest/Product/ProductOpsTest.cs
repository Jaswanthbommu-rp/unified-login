...
namespace UnifiedLogin.LandingAPI.Test.ControllerTest.Product
{
    ...
    public class ProductOpsTest
    {
        ...
        private const string _baseUrl = "http://localhost/api/products/ops";
        ...
        {
            //Arrange
            var expected = "ListOpsMigrationUsers";
        ...
        [Fact]
        public void DisableOpsUser_VerifyRouteToAction_ReturnAction()
        {
            //Arrange
            var expected = "UpdateOpsUserStatus";
